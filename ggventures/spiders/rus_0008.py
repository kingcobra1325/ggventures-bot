...
class Rus0008Spider(GGVenturesSpider):
    name = 'rus_0008'
    start_urls = ["https://buk.irk.ru/english/contact.php"]
    country = 'Russia'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Irkutsk State University,Baikal Institute for Business and International Management (BIBIM)"
    
    static_logo = "https://buk.irk.ru/english/images/logo.gif"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://isu.ru/en/research/upcoming_events/main/"

    university_contact_info_xpath = "//div[@class='colorlib-light-grey']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            self.check_website_changed(upcoming_events_xpath="//div[@class='LPageCss']",empty_text=True)
