...
class Phl0004Spider(GGVenturesSpider):
    name = 'phl_0004'
    start_urls = ["https://www.usc.edu.ph/"]
    country = 'Philippines'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "University of San Carlos,College of Commerce"
    
    static_logo = "https://www.usc.edu.ph/wp-content/themes/universityofgo665/images/main-logo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.usc.edu.ph/events-and-updates"

    university_contact_info_xpath = "//div[@class='contact_info']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.multi_event_pages(num_of_pages=8,event_links_xpath="//h2/a",next_page_xpath="//a[text()='›']",get_next_month=True,click_next_month=False,wait_after_loading=False,run_script=False):
            # for link in self.events_list(event_links_xpath="//h2/a"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=["https://www.usc.edu.ph/"]):
                    ...
                    item_data['event_desc'] = self.desc_images(desc_xpath="//main/div")
