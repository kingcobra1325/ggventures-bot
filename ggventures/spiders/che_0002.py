...
class Che0002Spider(GGVenturesSpider):
    name = 'che_0002'
    start_urls = ["https://www.gsb.uzh.ch/en/contactus.html"]
    country = 'Switzerland'
    # eventbrite_id = 6221361805

    handle_httpstatus_list = [301,302,403,404]

    static_name = "GSBA - Graduate School of Business Administration Zürich"
    
    static_logo = "https://www.gsb.uzh.ch/terrific/modules/Logo/img/uzh_logo_e_pos_web_main.jpg"
        ...
        ####################
            ...
            # for link in self.events_list(event_links_xpath="//h3/a"):
                ...
                if self.unique_event_checker(url_substring=["https://www.agenda.uzh.ch/record.php"]):
                    ...
                    try:
                        item_data['event_desc'] = self.desc_images(desc_xpath="//div[starts-with(@class,'eventItem')]/following-sibling::p")
