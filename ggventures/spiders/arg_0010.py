...
class Arg0010Spider(GGVenturesSpider):
    name = 'arg_0010'
    start_urls = ['https://www.unc.edu.ar/']
    country = "Argentina"
    ...
    static_name = "Universidad Nacional de Córdoba"
    static_logo = "https://ucema.edu.ar/sites/default/files/ucema_apaisado.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = f"https://www.unc.edu.ar/agenda/"
