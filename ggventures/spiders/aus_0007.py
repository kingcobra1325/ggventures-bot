...
class Aus0008Spider(GGVenturesSpider):
    name = 'aus_0007'
    start_urls = ['https://www.ecu.edu.au/schools/business-and-law/contact']
    country = 'Australia'
    ...
    static_name = "Edith Cowan University,Faculty of Business and Law"
    static_logo = "https://cdn.ecu.net.au/designs/ecu-internet-2016/css/global.css/ecu-logo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.ecu.edu.au/schools/business-and-law/news-and-events/school-of-business-and-law"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//h3/a"):
                ...
                if self.unique_event_checker(url_substring=['ecu.edu.au/schools/business-and-law/news-and-events']):
                    ...
                    item_data['event_desc'] = self.scrape_xpath(xpath_list=["//div[@class='span9']//div[@class='span12']"])
                    item_data['event_date'] = self.scrape_xpath(xpath_list=["//div[@class='span9']//div[@class='span12']"])
                    item_data['event_time'] = self.scrape_xpath(xpath_list=["//div[@class='span9']//div[@class='span12']"])
