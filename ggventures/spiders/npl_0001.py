...
class Npl0001Spider(GGVenturesSpider):
    name = 'npl_0001'
    start_urls = ['https://tribhuvan-university.edu.np/faculty/1_5dbbd9852140f']
    country = "Nepal"
    ...
    static_name = "Tribhuvan University,Faculty of Management"
    static_logo = "https://www.nust.na/sites/default/files/nust_logoANDname-DARKBACKGROUND.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "http://www.cecoma.uem.mz/eventos/"

    university_contact_info_xpath = "//h2[text()='Contact Us']/parent::div"
