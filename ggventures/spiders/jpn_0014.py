        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//header/a"):
                ...
                if self.unique_event_checker(url_substring=["https://cob.rikkyo.ac.jp/en/news/","https://english.rikkyo.ac.jp/news/"]):
                    ...
                    item_data['event_name'] = self.Mth.WebDriverWait(self.getter,20).until(self.Mth.EC.presence_of_element_located((self.Mth.By.XPATH,"//h2[@class='news-hed-title']"))).get_attribute('textContent')
                    
                    item_data['event_desc'] = self.desc_images(desc_xpath="//div[@class='image-text']")
