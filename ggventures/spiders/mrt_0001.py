...
class Mrt0001Spider(GGVenturesSpider):
    name = 'mrt_0001'
    start_urls = ['http://www.una.mr/fr/fsje/']
    country = "Mauritania"
    ...
    static_name = "Université de Nouakchott,Faculté des Sciences Juridiques et Economiques (FSJE)"
