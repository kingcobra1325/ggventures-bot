...
class Gbr0015Spider(GGVenturesSpider):
    name = "gbr_0015"
    start_urls = ["https://www.lancaster.ac.uk/lums/contact-us/"]
    country = "United Kingdom"
    eventbrite_id = 8447939505
# 
    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Lancaster University Management School"
    
    static_logo = "https://www.lancaster.ac.uk/media/wdp/style-assets/images/logos/lums-logo.svg"
