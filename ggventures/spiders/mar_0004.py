...
class Mar0004Spider(GGVenturesSpider):
    name = 'mar_0004'
    start_urls = ['https://hem.ac.ma/fr/contactez-nous']
    country = "Morocco"
    ...
    static_name = "HEM - Institut des Hautes Etudes de Management"
    static_logo = "https://s3.eu-central-1.amazonaws.com/stagiaires.ma/organisms/logos/2019/02/x100/34_hem-institut-des-hautes-tudes-de-management.jpeg?v=1549711354"
