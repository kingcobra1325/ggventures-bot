...
class Nga0001Spider(GGVenturesSpider):
    name = 'nga_0001'
    start_urls = ['https://oauife.edu.ng/contact-oau']
    country = "Nigeria"
    ...
    static_name = "Obafemi Awolowo University - Ile Ife,Faculty of Administration"
    static_logo = "https://oauife.edu.ng/images/logo-oau.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://oauife.edu.ng/news-events"

    university_contact_info_xpath = "//div[@class='tm-minibar']"
