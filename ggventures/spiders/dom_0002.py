...
class Dom0002Spider(GGVenturesSpider):
    name = 'dom_0002'
    start_urls = ['https://uasd.edu.do/index.php/economicas-y-sociales/']
    country = "Dominican Republic"
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404,429]

    static_name = "Universidad Autonoma da Santo Domingo,Facultad de Ciencias Económicas y Sociales"
    static_logo = "https://uasd.edu.do/images/logo-uasd_cambio4.jpg"
