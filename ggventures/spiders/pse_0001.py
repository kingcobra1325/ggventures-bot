...
class Pse0001Spider(GGVenturesSpider):
    name = 'pse_0001'
    start_urls = ['https://www.alquds.edu/en/contact-us/']
    ...
    static_name = "Al-Quds University,Faculty of Economics"
    static_logo = "https://www.alquds.edu/wp-content/uploads/2020/11/aqulogo-text-white-4.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.alquds.edu/en/life-at-aqu/events/"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            self.check_website_changed(upcoming_events_xpath="//h4[text()='Under construction']")
