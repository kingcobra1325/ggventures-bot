...
class Tur0009Spider(GGVenturesSpider):
    name = 'tur_0009'
    start_urls = ['https://itu.edu.tr/en/contact']
    country = "Turkey"
    ...
    static_name = "Istanbul Technical University"
    static_logo = "https://itu.edu.tr/Sitefinity/WebsiteTemplates/ITUTemplate/App_Themes/ITUTemplate/lib/img/itu-logo-white.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://itu.edu.tr/en/events-detail/"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            self.check_website_changed(upcoming_events_xpath="//div[@class='page-detail']//a",checking_if_none=True)
