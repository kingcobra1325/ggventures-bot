...
class Mex0008Spider(GGVenturesSpider):
    name = 'mex_0008'
    ...
    static_name = "Universidad Anáhuac del Sur,Escuela de Economía y Negocios"
    
    static_logo = "https://www.anahuac.mx/mexico/EscuelasyFacultades/economia/sites/default/files/inline-images/logo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.anahuac.mx/mexico/eventos"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//div[@class='event-title']/a"):
                ...
                if self.unique_event_checker(url_substring=["https://www.anahuac.mx/mexico/eventos/"]):
                    ...
                    item_data['event_name'] = self.Mth.WebDriverWait(self.getter,20).until(self.Mth.EC.presence_of_element_located((self.Mth.By.XPATH,"post-title"))).get_attribute('textContent')
