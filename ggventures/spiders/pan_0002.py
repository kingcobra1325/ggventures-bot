...
class Pan0002Spider(GGVenturesSpider):
    name = 'pan_0002'
    start_urls = ['https://www.ulatina.edu.pa/nuestra-universidad/directorio-telefonico/']
    country = "Panama"
    ...
    static_name = "Universidad Latina de Panamá,Facultad de Ciencias Administrativas y Económicas"
    static_logo = "https://www.ulatina.edu.pa/wp-content/uploads/2021/01/header_logo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.ulatina.edu.pa/vida-de-campus/noticias/"
