...
class Col0001Spider(GGVenturesSpider):
    name = 'col_0001'
    start_urls = ['https://www.javeriana.edu.co/contacto']
    country = "Colombia"
    ...
    static_name = "Pontificia Universidad Javeriana,Facultad de Ciencias Económicas y Administrativas"
    static_logo = "https://cea.javeriana.edu.co/documents/20129/601896/escudo-puj-bogota-sticky.png"
