...
class Usa0137Spider(GGVenturesSpider):
    name = 'usa_0137'
    start_urls = ["https://haslam.utk.edu/"]
    country = 'US'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "University of Tennessee at Knoxville,College of Business Administration"
    
    static_logo = "https://haslam.utk.edu/wp-content/uploads/2021/09/logosArtboard-11.jpg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://calendar.utk.edu/calendar"

    university_contact_info_xpath = "//footer[@class='footer']"
