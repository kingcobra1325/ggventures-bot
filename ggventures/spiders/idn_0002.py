...
class Idn0002Spider(GGVenturesSpider):
    name = 'idn_0002'
    start_urls = ['https://ugm.ac.id/en']
    country = "Indonesia"
    ...
    static_name = "Gadjah Mada University,Faculty of Economics"
    static_logo = "https://images.squarespace-cdn.com/content/v1/5e3b9109bcc56c7eb040a620/1581237767635-E6BADSR980BPU3IEQAOB/Logo+Tengah.png?format=1000w"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.ugm.ac.id/en/agenda/listAgenda"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//div[@class='post-title']/h3/a"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=['ugm.ac.id/en/agenda']):
                    ...
                    item_data['event_desc'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='post-content']").text
                    # try:
                    ...
                    item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='event-table']").text
                    item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='event-table']").text
