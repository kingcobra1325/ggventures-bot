...
class Bra0005Spider(GGVenturesSpider):
    name = 'bra_0005'
    start_urls = ["https://ebape.fgv.br/en"]
    country = 'Brazil'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "EBAPE/FGV - Fundação Getulio Vargas,Escola Brasileira de Administração Pública e de Empresas"
    
    static_logo = "https://ebape.fgv.br/sites/ebape.fgv.br/themes/ebape/logo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://ebape.fgv.br/en/programs/global-mba/events"

    university_contact_info_xpath = "//footer//div[starts-with(@class,'block-content')]"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//h2[text()='Projects']/..//div[@class='circular-title']/a"):
                ...
                if self.unique_event_checker(url_substring=["http://www.fgv.br/eventos/"]):
