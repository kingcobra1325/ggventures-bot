...
class Ecu0001Spider(GGVenturesSpider):
    name = 'ecu_0001'
    start_urls = ['https://www.espae.edu.ec/']
    country = "Ecuador"
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404,429]

    static_name = "ESPOL - Escuela Superior Politecnica del Litoral,ESPAE - Escuela de Postgrado en Administración de Empresas"
    static_logo = "https://www.espae.edu.ec/wp-content/uploads/2021/02/ESPAE01-1.svg"
