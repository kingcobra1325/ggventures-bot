...
class Lao0001Spider(GGVenturesSpider):
    name = 'lao_0001'
    start_urls = ['https://www.nuol.edu.la/']
    country = "Laos"
    ...
    static_name = "National University of Laos"
    static_logo = "https://catalyst-erasmus.com/wp-content/uploads/2018/03/NUoL-199x300.jpg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://cbaweb.ku.edu.kw/events/"

    university_contact_info_xpath = "//div[@id='Mod125']"
