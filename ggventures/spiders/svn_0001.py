...
class Svn0001Spider(GGVenturesSpider):
    name = 'svn_0001'
    start_urls = ['http://gea-college.si/en/']
    country = "Slovenia"
    ...
    static_name = "GEA College"
    static_logo = "https://gea-college.si/wp-content/uploads/2015/07/logo.png"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            self.check_website_changed(upcoming_events_xpath="//div[contains(@class,'events')]//a",checking_if_none=True)
