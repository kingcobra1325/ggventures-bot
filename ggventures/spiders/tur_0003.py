...
class Tur0003Spider(GGVenturesSpider):
    name = 'tur_0003'
    start_urls = ["https://www.gsu.edu.tr/en/contact"]
    country = 'Turkey'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Galatasaray Üniversitesi"
    
    static_logo = "https://dosya.gsu.edu.tr/StaticContent/Logolar/GalatasarayUniversitesi/TR.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.gsu.edu.tr/"
