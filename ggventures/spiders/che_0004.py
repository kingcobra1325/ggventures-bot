...
class Che0004Spider(GGVenturesSpider):
    name = 'che_0004'
    start_urls = ["https://www.imd.org/about-imd/contact-us/"]
    country = 'Switzerland'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "IMD - International Institute for Management Development"
    
    static_logo = "https://upload.wikimedia.org/wikipedia/commons/f/f0/IMD_logo.jpg"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//div[@class='card-buttons']/a"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=["https://www.imd.org/event/"]):
                    ...
                    item_data['event_desc'] = self.desc_images(desc_xpath="//section[starts-with(@class,'section')] | //div[@id='event-content']")
                    ...
                    try:
                        item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='key-info-item-text']").get_attribute('textContent')
                        item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='key-info-item-text']").get_attribute('textContent')
