...
class Tgo0001Spider(GGVenturesSpider):
    name = 'tgo_0001'
    start_urls = ['https://univ-lome.tg/universite/organisation/faseg']
    country = "Togo"
    ...
    static_name = "Université de Lomé - Faculté des Sciences Economiques et de Gestion (FASEG)"
    static_logo = "https://univ-lome.tg/sites/default/files/LOGO%20COULEUR%20TRANSP_0.png"
        ...
        ####################
            ...
            for link in self.multi_event_pages(num_of_pages=5,event_links_xpath="//span[@class='field-content']/a",next_page_xpath="//a[@rel='next']",get_next_month=True):
                ...
                if self.unique_event_checker(url_substring=['univ-lome.tg']):
                    ...
                    item_data['event_desc'] = self.getter.find_element(self.Mth.By.XPATH,"//div[contains(@class,'node__content')]").get_attribute('textContent')
                    # try:
