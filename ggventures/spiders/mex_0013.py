...
class Mex0013Spider(GGVenturesSpider):
    name = 'mex_0013'
    start_urls = ["http://www.cucea.udg.mx/es/contacto"]
    country = 'Mexico'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Universidad de Guadalajara,CUCEA - Centro Universitario de Ciencias Economico Administrativas"
    
    static_logo = "http://www.cucea.udg.mx/sites/default/files/logo.jpg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.xoc.uam.mx/calendar"

    university_contact_info_xpath = "//strong[text()='Teléfono: ']/.."
