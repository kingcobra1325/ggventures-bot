...
class Hun0002Spider(GGVenturesSpider):
    name = 'hun_0002'
    start_urls = ['https://www.ceu.edu/contact']
    country = "Hungary"
    ...
    static_name = "Central European University,CEU Business School"
    static_logo = "https://upload.wikimedia.org/wikipedia/commons/3/31/CEU_logo_color.jpg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://events.ceu.edu/search/events"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.multi_event_pages(num_of_pages=4,event_links_xpath="//h2/a",next_page_xpath="//a[@rel='next']",get_next_month=True,click_next_month=False,wait_after_loading=False):
                ...
                if self.unique_event_checker(url_substring=['events.ceu.edu']):
                    ...
                    item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='event__date']").text
                    item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='event__date']").text
