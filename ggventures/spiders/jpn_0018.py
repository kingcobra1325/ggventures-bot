...
class Jpn0018Spider(GGVenturesSpider):
    name = 'jpn_0018'
    start_urls = ["https://www.tus.ac.jp/en/contact/"]
    country = 'Japan'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Tokyo University of Science (TUS),School of Management"
    
    static_logo = "https://www.tus.ac.jp/en/assets/img/common/logo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.tus.ac.jp/en/news/05/"

    university_contact_info_xpath = "//div[@class='contact__box']/.."
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//h4[@class='news-archive__ttl']/a"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=["https://www.tus.ac.jp/en/news/archive/"]):
                    ...
                    item_data['event_name'] = self.Mth.WebDriverWait(self.getter,20).until(self.Mth.EC.presence_of_element_located((self.Mth.By.XPATH,"//h2[@class='news-article__ttl']"))).get_attribute('textContent')
                    
                    item_data['event_desc'] = self.desc_images(desc_xpath="//div[@class='news-article__body']")
