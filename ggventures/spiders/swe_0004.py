        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//div[starts-with(@class,'border-bottom')]/a"):
                ...
                if self.unique_event_checker(url_substring=["https://www.lusem.lu.se/calendar/"]):
                    ...
                    # item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//p[starts-with(@class,'text-center')]").get_attribute('textContent')
                    # item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//p[starts-with(@class,'text-center')]").get_attribute('textContent')
                    ...
                    try:
                        item_data['startups_contact_info'] = self.getter.find_element(self.Mth.By.XPATH,"//h3[text()='Contact']/..").get_attribute('textContent')
                    except self.Exc.NoSuchElementException as e:
                        self.Func.print_log(f"XPATH not found {e}: Skipping.....")
