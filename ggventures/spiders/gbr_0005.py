...
class Gbr0005Spider(GGVenturesSpider):
    name = "gbr_0005"
    start_urls = ["https://www.brunel.ac.uk/about/contact-us"]
    country = "United Kingdom"
    eventbrite_id = 7561276005
# 
    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Brunel University,Brunel Business School"
    
    static_logo = "https://www.brunel.ac.uk/SiteElements/images/brunel-business-school-logo.png"
