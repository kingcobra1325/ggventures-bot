...
class Zaf0009Spider(GGVenturesSpider):
    name = 'zaf_0009'
    start_urls = ["https://regenesys.net/contact-us/"]
    country = 'South Africa'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Regenysis Business School (RBS)"
    
    static_logo = "https://regenesys.net/wp-content/uploads/2021/05/187x50_Black.png"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            self.check_website_changed(upcoming_events_xpath="//li[contains(text(),'There are no upcoming events.')]",empty_text=False)
