...
class Chn0027Spider(GGVenturesSpider):
    name = 'chn_0027'
    start_urls = ["https://wsb1.qhu.edu.cn/gywm/lxfs.htm"]
    country = 'China'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Qinghai University"
    
    static_logo = "https://www.qhu.edu.cn/images/20161123/logo.png"
