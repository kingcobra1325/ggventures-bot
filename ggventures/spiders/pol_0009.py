...
class Pol0009Spider(GGVenturesSpider):
    name = 'pol_0009'
    start_urls = ["https://en.uw.edu.pl/contacts/"]
    country = 'Poland'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "University of Warsaw,School of Management"
    ...
    university_contact_info_xpath = "//div[not(@*)]"
