...
class Civ0002Spider(GGVenturesSpider):
    name = 'civ_0002'
    start_urls = ['https://univ-cocody.ci/']
    country = "Ivory Coast"
    ...
    static_name = "Université de Cocody - Abidjan"
    static_logo = "https://univ-cocody.ci/wp-content/uploads/2019/02/univ-cocody1.png"
