...
class Per0001Spider(GGVenturesSpider):
    name = 'per_0001'
    start_urls = ['https://www.pucp.edu.pe/unidad/centrum']
    country = "Peru"
    ...
    static_name = "Pontificia Universidad Catolica del Peru,Centrum Católica"
    static_logo = "https://dape.pucp.edu.pe/wp-content/uploads/2021/05/nuevo-logo-centrum-largo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://agenda.pucp.edu.pe/home/"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//a[contains(@class,'event-card')]"):
                ...
                if self.unique_event_checker(url_substring=['agenda.pucp.edu.pe/evento']):
                    ...
                    item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='div-block-2']").text
                    item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='div-block-2']").text
