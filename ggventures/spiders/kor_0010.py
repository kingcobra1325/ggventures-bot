...
class Kor0010Spider(GGVenturesSpider):
    name = 'kor_0010'
    start_urls = ["https://biz.pusan.ac.kr/bizeng/14387/subview.do"]
    country = 'South Korea'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Pusan National University,Graduate School of Management"
    
    static_logo = "https://biz.pusan.ac.kr/sites/bizeng/masterSkin/bizeng_main/images/2.png"
