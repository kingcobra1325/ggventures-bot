...
class Tur0005Spider(GGVenturesSpider):
    name = 'tur_0005'
    start_urls = ["https://isletme.istanbul.edu.tr/en/iletisim"]
    country = 'Turkey'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Istanbul University,Faculty of Business Management"
    
    static_logo = "https://cdn.istanbul.edu.tr/FileHandler.ashx?f=nlh7zZUWB0yWB6DfLe44ng"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://isletme.istanbul.edu.tr/en/_"
