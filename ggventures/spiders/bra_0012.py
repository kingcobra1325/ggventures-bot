...
class Bra0012Spider(GGVenturesSpider):
    name = 'bra_0012'
    start_urls = ["https://www.face.ufmg.br/contatos/email-institucional.html"]
    country = 'Brazil'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "UFMG/FACE - Universidade Federal de Minas Gerais,Faculdade de Ciências Econômicas"
    
    static_logo = "https://www.face.ufmg.br/images/template/face.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://pesquisas.face.ufmg.br/ecult/en/news/"

    university_contact_info_xpath = "//div[@id='custom-6032-particle']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//h2/a"):
                ...
                if self.unique_event_checker(url_substring=["https://pesquisas.face.ufmg.br/ecult/en/"]):
                    ...
                    item_data['event_desc'] = self.desc_images(desc_xpath="//div[starts-with(@class,'col-md-8')]")
