...
class Mus0001Spider(GGVenturesSpider):
    name = 'mus_0001'
    start_urls = ['https://www.uom.ac.mu/flm/index.php/86-foa/154-contactus']
    country = "Mauritius"
    ...
    static_name = "University of Mauritius,Department of Management (DOM)"
    static_logo = "https://www.uom.ac.mu/templates/jsn_mico_pro/images/colors/blue/logo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.uom.ac.mu/index.php/113-events/newsevents/"

    university_contact_info_xpath = "//div[@id='jsn-body']"
