        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//section//div[@class='events-items']//a"):
                ...
                if self.unique_event_checker(url_substring=["https://mgubs.ru/allevents/"]):
                    ...
                    item_data['event_date'] = self.scrape_xpath(xpath_list=["//div[@class='events-date']"],method='attr')
                    item_data['event_time'] = self.scrape_xpath(xpath_list=["//div[@class='events-date']"],method='attr')
