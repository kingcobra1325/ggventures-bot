...
class Nld0013Spider(GGVenturesSpider):
    name = 'nld_0013'
    start_urls = ["https://www.rug.nl/info/contact"]
    country = 'Netherlands'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "University of Groningen,Faculty of Management and Organization"
    
    static_logo = "https://www.rug.nl/_definition/shared/images/logo--en.svg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.rug.nl/about-ug/latest-news/events/calendar/"

    university_contact_info_xpath = "//table[@class='rug-table--default']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//a[@class='h4']"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=["https://www.rug.nl/about-ug/latest-news/events/"]):
                    ...
                    item_data['event_desc'] = self.desc_images(desc_xpath="//div[starts-with(@class,'rug-clearfix')]")
