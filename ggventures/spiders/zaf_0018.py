...
class Zaf0018Spider(GGVenturesSpider):
    name = 'zaf_0018'
    start_urls = ["https://www.ufs.ac.za/homepage/contact-us"]
    country = 'South Africa'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "University of the Free State - Universiteit van die Vrystaat,School of Management"
    
    static_logo = "https://www.ufs.ac.za/images/librariesprovider5/ufs_redesign_2021/ufsheaderlogo.svg?sfvrsn=15b37820_2"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.ufs.ac.za/templates/calendar"

    university_contact_info_xpath = "//div[@id='UserContent']//div[starts-with(@class,'sfContentBlock')]"
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//div[@class='calendar-text']/strong/a"):
                ...
                if self.unique_event_checker(url_substring=["https://www.ufs.ac.za/templates/calendar-item/"]):
                    ...
                    item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//div[starts-with(@class,'sfitemDetails')]").get_attribute('textContent')
                    item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//div[starts-with(@class,'sfitemDetails')]").get_attribute('textContent')
