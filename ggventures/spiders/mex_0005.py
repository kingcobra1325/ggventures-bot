...
class Mex0005Spider(GGVenturesSpider):
    name = 'mex_0005'
    start_urls = ["https://tec.mx/en/contact-us"]
    country = 'Mexico'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "ITESM - Campus Queretaro"
    
    static_logo = "https://queretaro.itesm.mx/wp-content/uploads/2015/06/LogoTecPeque%C3%B1o.png"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//a[@role='article']"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=["https://tec.mx/es/exatec/eventos/"]):
