...
class Are0004Spider(GGVenturesSpider):
    name = 'are_0004'
    start_urls = ['https://www.zu.ac.ae/main/en/colleges/colleges/__college_of_business/contact_us.aspx']
    ...
    static_name = "Zayed University (ZU),College of Business Sciences"
