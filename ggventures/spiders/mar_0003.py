...
class Mar0003Spider(GGVenturesSpider):
    name = 'mar_0003'
    start_urls = ['http://https://m.facebook.com/profile.php?id=336373889781410/']
    country = "Morocco"
    ...
    static_name = "ESCA - Ecole Supérieure du Commerce et des Affaires"
    static_logo = "https://encg-settat.ma/site/img/logo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://encg-settat.ma/evenements"

    university_contact_info_xpath = "//div[@class='contact-us-info2']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.multi_event_pages(num_of_pages=3,event_links_xpath="//h3/a",next_page_xpath="//a[@rel='next']",get_next_month=True,click_next_month=False):
                ...
                if self.unique_event_checker(url_substring=['encg-settat.ma/evenement']):
                    ...
                    item_data['event_desc'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='event-details-inner']").text
                    # try:
                    #     item_data['event_desc'] = self.getter.find_element(self.Mth.By.XPATH,"//div[contains(@class,'event-desc')]").text
                    # except self.Exc.NoSuchElementException as e:
                    #     self.Func.print_log(f"XPATH not found {e}: Skipping.....",'debug')

                    item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//ul[contains(@class,'event-info-inline')]").text
                    item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//ul[contains(@class,'event-info-inline')]").text
