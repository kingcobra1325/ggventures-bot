...
class Lva0001Spider(GGVenturesSpider):
    name = 'lva_0001'
    start_urls = ['https://www.ba.lv/university/contacts-and-structure/']
    country = "Latvia"
    ...
    static_name = "Banking Institution of Higher Education,Banku Augstskola"
    static_logo = "https://www.ba.lv/wp-content/themes/ba/images/ba-logo-lv.svg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://cbaweb.ku.edu.kw/events/"

    university_contact_info_xpath = "//ul[contains(@class,'cont-and-struct__contacts')]"
