...
class Tun0001Spider(GGVenturesSpider):
    name = 'tun_0001'
    start_urls = ['http://www.essect.rnu.tn/fra/contact']
    country = "Tunisia"
    ...
    static_name = "ESSEC Tunis"
    static_logo = "http://www.essect.rnu.tn/stylesheets/images/logo.png"
