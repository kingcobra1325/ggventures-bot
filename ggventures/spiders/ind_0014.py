...
class Ind0014Spider(GGVenturesSpider):
    name = 'ind_0014'
    ...
    static_name = "Indian Institute of Management Calcutta (IIM-C)"
    
    static_logo = "https://www.iimcal.ac.in/sites/all/files/images/logo.png"
