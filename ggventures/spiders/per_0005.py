...
class Per0005Spider(GGVenturesSpider):
    name = 'per_0005'
    start_urls = ['https://www.upc.edu.pe/servicios/contacto-para-alumnos-upc/']
    country = "Peru"
    ...
    static_name = "Universidad Peruana de Ciencias Aplicadas (UPC),Escuela de Empresa"
    static_logo = "https://www.upc.edu.pe/static/img/logo_upc_red.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://pregrado.upc.edu.pe/"
