...
class Esp0009Spider(GGVenturesSpider):
    ...
    static_name = "ESERP - Fundación Universitaria"
    
    static_logo = "https://en.eserp.com/wp-content/uploads/2020/05/eserp-home-en-1.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://es.eserp.com/eventos/"

    university_contact_info_xpath = "//div[starts-with(@class,'normalbar')]"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//span[@class='categoria-evento']/../a"):
                ...
                if self.unique_event_checker(url_substring=["https://es.eserp.com/evento/"]):
                    ...
                    item_data['event_desc'] = self.desc_images(desc_xpath="//div[starts-with(@class,'seccion')]")

                    item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//h2[text()='Detalles del ']/..").get_attribute('textContent')
                    item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//h2[text()='Detalles del ']/..").get_attribute('textContent')
