...
class Egy0003Spider(GGVenturesSpider):
    name = 'egy_0003'
    start_urls = ['https://www.aast.edu/en/colleges/gsb/']
    country = "Egypt"
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404,429]

    static_name = "Arab Academy for Science & Technology,Graduate Business School"
    static_logo = "https://media-exp1.licdn.com/dms/image/C4D0BAQF_jbiMqup0Pg/company-logo_200_200/0/1586264485103?e=2159024400&v=beta&t=Uaj4XMUX-1osdTeyHfRv2Y3sewe1ViG4m4wqg7hrw7M"
