...
class Ind0016Spider(GGVenturesSpider):
    name = 'ind_0016'
    start_urls = ["https://www.iimcal.ac.in/contacts"]
    country = 'India'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Indian Institute of Management Kozhikode (IIM-K)"
    
    static_logo = "https://iimk.ac.in/images/logo2.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://iimk.ac.in/events"

    university_contact_info_xpath = "//div[@class='about-prog']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            self.check_website_changed(upcoming_events_xpath="//h4[text()='There is no active events.']",empty_text=False)
            ...
            #     if self.unique_event_checker(url_substring=["https://www.iimcal.ac.in/"]):
            ...
            #         item_data['event_desc'] = self.desc_images(desc_xpath="//div[@class='inner-content-hld']")
