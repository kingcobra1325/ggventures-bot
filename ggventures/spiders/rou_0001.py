...
class Rou0001Spider(GGVenturesSpider):
    name = 'rou_0001'
    start_urls = ['https://www.asebuss.ro/contact/']
    country = "Romania"
    ...
    static_name = "ASEBUSS - Institute for Business and Public Administration (ASEBUSS)"
