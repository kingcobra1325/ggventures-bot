...
class Jpn0007Spider(GGVenturesSpider):
    name = 'jpn_0007'
    start_urls = ["https://www.kansai-u.ac.jp/English/info/contact/"]
    country = 'Japan'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Kansai University"
    
    static_logo = "https://www.kansai-u.ac.jp/English/assets/img/common/parts/logo_head.svg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.kansai-u.ac.jp/English/about/pr/news/"

    university_contact_info_xpath = "//div[@id='contents']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            self.driver.find_element(self.Mth.By.XPATH,"//a[text()='EVENT']").click()
    
            self.check_website_changed(upcoming_events_xpath="//h3[text()='No information for the year']",empty_text=False)
