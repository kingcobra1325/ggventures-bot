...
class Kor0011Spider(GGVenturesSpider):
    name = 'kor_0011'
    start_urls = ["http://graduatebusiness.sejong.ac.kr/Eng/AboutSejong/Faculty"]
    country = 'South Korea'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Sejong University,School of Business"
    
    static_logo = "https://graduatebusiness.sejong.ac.kr/Areas/Eng/Content/images/inc/logo.jpg"
