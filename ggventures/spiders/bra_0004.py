...
class Bra0004Spider(GGVenturesSpider):
    name = 'bra_0004'
    start_urls = ["https://eaesp.fgv.br/en/contact-us"]
    country = 'Brazil'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "EAESP/FGV - Fundação Getulio Vargas,Escola de Administração de Empresas de São Paulo"
    
    static_logo = "https://eaesp.fgv.br/sites/eaesp.fgv.br/files/logo_en_0_0.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://eaesp.fgv.br/en/eaesp-news"

    university_contact_info_xpath = "//h2[text()='Visit FGV EAESP']/.."
