...
class Slv0001Spider(GGVenturesSpider):
    name = 'slv_0001'
    start_urls = ['http://fce.ues.edu.sv/directorios']
    country = "El Salvador"
    ...
    static_name = "Universidad de El Salvador,Faculdad de Ciencias Economicas"
    static_logo = "http://fce.ues.edu.sv/themes/jtherczeg-corlate/assets/images/logos/ues-logo-gris-texto-v3.svg"
