...
class Idn0001Spider(GGVenturesSpider):
    name = 'idn_0001'
    start_urls = ['https://feb.unair.ac.id/en/helpdesk-feb-unair.html']
    country = "Indonesia"
    ...
    static_name = "Airlangga University,Faculty of Economy"
    static_logo = "https://w7.pngwing.com/pngs/881/345/png-transparent-faculty-of-economics-and-business-airlangga-university-bogor-agricultural-university-logo-indonesia-batik-miscellaneous-furniture-monochrome.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://en.ru.is/ise/about/news-and-events/"

    university_contact_info_xpath = "//div[@class='text-content']"
