...
class Sau0006Spider(GGVenturesSpider):
    name = 'sau_0006'
    start_urls = ['https://eduniversal-ranking.com/business-school-university-ranking-in-saudi-arabia/qutorba-human-management-development-social-studies/profile-qutorba-human-management-development-social-studies.html/']
    ...
    static_name = "Qutorba Human & Management Development"
    static_logo = "https://ksu.edu.sa/assets/img/logo.png"
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//div[@class='card card-blog']/a"):
                ...
                if self.unique_event_checker(url_substring=['news.ksu.edu.sa/ar/node']):
                    ...
                    item_data['event_desc'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@id='block-system-main']").text
                    # try:
