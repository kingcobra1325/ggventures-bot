...
class Isr0003Spider(GGVenturesSpider):
    name = 'isr_0003'
    start_urls = ['https://en.huji.ac.il/en/links/6474']
    country = "Israel"
    ...
    static_name = "Hebrew University of Jerusalem (HUJI),Jerusalem School of Business Administration"
    static_logo = "https://imba.huji.ac.il/profiles/openscholar/themes/os_bootstrap/images/logo_ltr.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://en.huji.ac.il/en/events"

    university_contact_info_xpath = "//div[@id='block-system-main']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            self.check_website_changed(upcoming_events_xpath="//p[contains(text(),'No Future Events')]")
