...
class Are0002Spider(GGVenturesSpider):
    name = 'are_0002'
    start_urls = ['https://www.uaeu.ac.ae/en/contact/']
    ...
    static_name = "United Arab Emirates University (UAEU),College of Business and Economics"
    static_logo = "https://cbe.uaeu.ac.ae/images/cbe-logo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://cbe.uaeu.ac.ae/en/events/"
