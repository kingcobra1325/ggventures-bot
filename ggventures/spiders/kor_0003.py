...
class Kor0003Spider(GGVenturesSpider):
    name = 'kor_0003'
    ...
    static_name = "Chungnam National University,College of Economics and Management"
    
    static_logo = "https://plus.cnu.ac.kr/images/en/common/logo_en.png"
