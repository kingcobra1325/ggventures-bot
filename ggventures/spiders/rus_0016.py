...
class Rus0016Spider(GGVenturesSpider):
    name = 'rus_0016'
    start_urls = ["https://www.hse.ru/en/contacts.html"]
    country = 'Russia'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "State University - Higher School of Economics,Graduate Management School"
    
    static_logo = "https://gsb.hse.ru/images/main_en/hse_en_logo.svg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://gsb.hse.ru/en/announcements/"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            self.check_website_changed(upcoming_events_xpath="//div[@class='content__inner']",empty_text=True)
