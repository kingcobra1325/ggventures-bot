...
class Gab0001Spider(GGVenturesSpider):
    name = 'gab_0001'
    start_urls = ['https://www.sygor.ga/home']
    country = "Gabon"
    ...
    static_name = "Université Omar Bongo,Faculté de droit et sciences économiques (F.D.S.E.)"
    static_logo = "https://www.sygor.ga/images/shared/logo.png"
