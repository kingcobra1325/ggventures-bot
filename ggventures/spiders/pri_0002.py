...
class Pri0002Spider(GGVenturesSpider):
    name = 'pri_0002'
    start_urls = ['https://fae.uprrp.edu/contactos/']
    ...
    static_name = "Universidad de Puerto Rico - Recinto de Río Piedras,Facultad de Administración de Empresas"
    static_logo = "https://www.uprrp.edu/wp-content/uploads/2021/06/uprrp-logo.png"
