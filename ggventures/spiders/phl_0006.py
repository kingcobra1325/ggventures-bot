...
class Phl0006Spider(GGVenturesSpider):
    name = 'phl_0006'
    start_urls = ["https://www.vsb.upd.edu.ph/contact-information"]
    country = 'Philippines'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "University of the Philippines (UP),College of Business Administration"
    
    static_logo = "https://lh4.googleusercontent.com/xkFwnZq4KSWS2e4WqAXhQahiYwaj3AVzfi8rHB1ESe_4RwQWTVhM-jPmYO0rHXyyt9YlNGq-iBbxySN4PiIIc1o=w16383"
