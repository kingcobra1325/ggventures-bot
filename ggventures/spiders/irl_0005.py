...
class Irl0005Spider(GGVenturesSpider):
    name = 'irl_0005'
    start_urls = ['https://www.smurfitschool.ie/']
    country = "Ireland"
    ...
    static_name = "University College Dublin,Smurfit School of Business"
    static_logo = "https://ft-bschool-rankings.s3.eu-west-2.amazonaws.com/staging/images/59c9b761-a520-462c-a683-7ac5e213a2ef-e304ac1cff8587c12ad645674e5667b4"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.smurfitschool.ie/events/"

    university_contact_info_xpath = "//h4[contains(text(),'Contact Us')]/following-sibling::ul"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//h2[contains(text(),'Search by')]/parent::div/parent::section//a"):
                ...
                if self.unique_event_checker(url_substring=['www.smurfitschool.ie/events']):
