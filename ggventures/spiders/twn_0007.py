...
class Twn0007Spider(GGVenturesSpider):
    name = 'twn_0007'
    start_urls = ["https://management.ntu.edu.tw/en/ContactUs"]
    country = 'Taiwan'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "National Taiwan University,College of Management"
    
    static_logo = "https://management.ntu.edu.tw/cm/index_area/1/5/000005.png"
