...
class Idn0006Spider(GGVenturesSpider):
    name = 'idn_0006'
    start_urls = ['https://www.undip.ac.id/language/en/faculty/faculty-of-economics-and-business/']
    country = "Indonesia"
    ...
    static_name = "Universitas Diponegoro,Faculty of Economics"
    static_logo = "https://www.undip.ac.id/wp-content/uploads/2021/07/Logo-Undip-2021.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.undip.ac.id/language/en/post/category/events-en/"

    university_contact_info_xpath = "//div[@id='text-10']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//article/a"):
                ...
                if self.unique_event_checker(url_substring=['www.undip.ac.id/language/en/post']):
