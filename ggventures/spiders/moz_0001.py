...
class Moz0001Spider(GGVenturesSpider):
    name = 'moz_0001'
    start_urls = ['https://www.uem.mz/']
    country = "Mozambique"
    ...
    static_name = "Universidade Eduardo Mondlane"
    static_logo = "https://oceanfdn.org/wp-content/uploads/2020/05/Eduardo-Mondlane-University.png"
