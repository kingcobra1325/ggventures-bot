...
class Usa0021Spider(GGVenturesSpider):
    name = 'usa_0021'
    start_urls = ["https://www.creighton.edu/ask"]
    country = 'US'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Creighton University,College of Business Administration (COBA)"
    
    static_logo = "https://www.creighton.edu/themes/creighton/images/Creighton-University-Logo-white.svg"
