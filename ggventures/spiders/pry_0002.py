...
class Pry0002Spider(GGVenturesSpider):
    name = 'pry_0002'
    start_urls = ['https://www.uaa.edu.py/contacto']
    country = "Paraguay"
    ...
    static_name = "Universidad Autónoma de Asunción,Facultad de Ciencias Económicas y Empresariales"
    static_logo = "https://www.uaa.edu.py/assets/img/escudo_uaa.png"
