...
class Rus0009Spider(GGVenturesSpider):
    name = 'rus_0009'
    start_urls = ["https://eng.kpfu.ru/contact-us/"]
    country = 'Russia'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Kazan State Institute of Finance and Economics,School of Business"
    
    static_logo = "https://eng.kpfu.ru/wp-content/themes/kpfu/images/logo.svg"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//div[starts-with(@class,'uk-width-1-1')]/a"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=["https://eng.kpfu.ru/bez-rubriki/"]):
                    ...
                    item_data['event_desc'] = self.scrape_xpath(xpath_list=["//div[@id='center']"],method='attr',enable_desc_image=True)
