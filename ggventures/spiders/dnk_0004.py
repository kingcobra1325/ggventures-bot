...
class Dnk0004Spider(GGVenturesSpider):
    name = 'dnk_0004'
    start_urls = ['https://www.sdu.dk/en/service/kontakt']
    country = "Denmark"
    # eventbrite_id = 6221361805

    handle_httpstatus_list = [301,302,403,404,429]

    static_name = "University of Southern Denmark,Syddansk Universitet"
    static_logo = "https://res.cloudinary.com/crunchbase-production/image/upload/c_lpad,h_256,w_256,f_auto,q_auto:eco,dpr_1/hasrsiwhw7pucjy54xpv"
