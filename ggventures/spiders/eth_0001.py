...
class Eth0001Spider(GGVenturesSpider):
    name = 'eth_0001'
    start_urls = ['http://www.aau.edu.et/cbe/about/contacts/']
    country = "Ethiopia"
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404,429]

    static_name = "Addis Ababa University,Faculty of Business & Economics (FBE)"
    static_logo = "http://www.aau.edu.et/cbe/wp-content/uploads/sites/7/2016/04/cbewall.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "http://www.aau.edu.et/cbe/events-calendar/acadamic-caledar/"

    university_contact_info_xpath = "//div[contains(@id,'post-54')]"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            #     if self.unique_event_checker(url_substring=['taltech.ee/en/events']):
            #
            ...
            #
            #         item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//div[contains(@class,'page-header__event')]").get_attribute('textContent')
            #         item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//div[contains(@class,'page-header__event')]").get_attribute('textContent')
            #
            #         # try:
