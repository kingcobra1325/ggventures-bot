...
class Pri0003Spider(GGVenturesSpider):
    name = 'pri_0003'
    start_urls = ['https://www.uprm.edu/adem/contactenos/']
    ...
    static_name = "Universidad de Puerto Rico - Recinto Mayagüez,Colegio de Administración de Empresas"
    static_logo = "https://www.uprm.edu/adem/wp-content/uploads/sites/112/2021/10/upr_rum.jpg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://fae.uprrp.edu/blog/category/eventos/"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//h2[@class='post-title']/a"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=['fae.uprrp.edu/blog']):
