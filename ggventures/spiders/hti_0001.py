...
class Hti0001Spider(GGVenturesSpider):
    name = 'hti_0001'
    start_urls = ['http://https://www.undh.edu.ht/index.php/ct-menu-item-51/106-articles/664-article-14/']
    country = "Haiti"
    ...
    static_name = "Université Notre-Dame d'Haïti,Faculté des Sciences Economiques, Sociales et Politiques (FSESP)"
    static_logo = "https://www.undh.edu.ht/images/logo_undh.png"
