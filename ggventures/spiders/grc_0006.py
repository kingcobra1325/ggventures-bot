...
class Grc0006Spider(GGVenturesSpider):
    name = 'grc_0006'
    start_urls = ['https://www.acg.edu/about-acg/contact-information/']
    country = "Greece"
    ...
    static_name = "The American College of Greece"
    static_logo = "https://www.acg.edu/wp-content/uploads/2017/04/logo_white_ACGBigger.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.acg.edu/events/"

    university_contact_info_xpath = "//div[@itemprop='mainContentOfPage']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//ul[@data-role='listview']//a",return_elements=True):
                # self.getter.get(link)
                self.getter.get(response.url)
                LoadMore = self.Mth.WebDriverWait(self.getter,20).until(self.Mth.EC.element_to_be_clickable((self.Mth.By.XPATH, )))
