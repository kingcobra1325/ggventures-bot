...
class Esp0024Spider(GGVenturesSpider):
    name = 'esp_0024'
    start_urls = ["https://www.comillas.edu/descarga-de-folletos/informacion-de-contacto"]
    country = 'Spain'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Universidad Pontificia Comillas de Madrid (ICADE)"
    
    static_logo = "https://upload.wikimedia.org/wikipedia/commons/e/e4/Comillas_Universidad_Pontificia_logo_%282018%29.jpg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://eventos.comillas.edu/search/basic_search.html"

    university_contact_info_xpath = "//p[@class='info street']/.."
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            # for link in self.events_list(event_links_xpath="//span[@class='categoria-evento']/../a"):
                ...
                if self.unique_event_checker(url_substring=["https://eventos.comillas.edu/"]):
                    ...
                    item_data['event_desc'] = self.desc_images(desc_xpath="//div[@id='content']/div[2]/div")
