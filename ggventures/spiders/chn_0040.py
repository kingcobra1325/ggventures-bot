        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//ul[starts-with(@class,'events')]/li/a"):
                ...
                if self.unique_event_checker(url_substring=["http://www.tju.edu.cn/english/info/"]):
                    ...
                    item_data['event_desc'] = self.desc_images(desc_xpath="//div[@class='fck']")

                    # item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//strong[text()='Time:']/.. | //p[contains(text(),'Time')]").get_attribute('textContent')
                    # item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//strong[text()='Time:']/.. | //p[contains(text(),'Time')]").get_attribute('textContent')
                    
                    # item_data['startups_contact_info'] = self.getter.find_element(self.Mth.By.XPATH,"//table[@class='event-table']").get_attribute('textContent')

                    try:
                        item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//strong[text()='Time:']/.. | //p[contains(text(),'Time') or contains(text(),'When')]").get_attribute('textContent')
                        item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//strong[text()='Time:']/.. | //p[contains(text(),'Time') or contains(text(),'When')]").get_attribute('textContent')
