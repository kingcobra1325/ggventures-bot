...
class Prt0001Spider(GGVenturesSpider):
    name = 'prt_0001'
    start_urls = ['https://www.aese.pt/']
    country = "Portugal"
    ...
    static_name = "AESE,Escola de Direcção e Negócios"
    static_logo = "https://www.aese.pt/wp-content/uploads/2019/02/Logo_AESE_white_EN.png"
