        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//span[@class='column-news-title']/a"):
                ...
                if self.unique_event_checker(url_substring=["https://www.scut.edu.cn/en/"]):
                    ...
                    item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='wp_articlecontent']").get_attribute('textContent')
                    item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='wp_articlecontent']").get_attribute('textContent')
