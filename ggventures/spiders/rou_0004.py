...
class Rou0004Spider(GGVenturesSpider):
    name = 'rou_0004'
    start_urls = ['https://www.uaic.ro/en/studies/faculties/faculty-economics-business-administration/']
    country = "Romania"
    ...
    static_name = "University Alexandru Ioan Cuza,Faculty of Economics and Business Administration"
    static_logo = "https://www.uaic.ro/wp-content/uploads/2013/12/logouaic.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.uaic.ro/en/international/events/"

    university_contact_info_xpath = "//div[@class='fusion-text']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            #     if self.unique_event_checker(url_substring=['bism.ro/event']):
            #
            ...
            #
            #         item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//div[contains(@class,'tribe-events-event-meta')]").text
            #         item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//div[contains(@class,'tribe-events-event-meta')]").text
            #
