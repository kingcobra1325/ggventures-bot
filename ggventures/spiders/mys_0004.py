...
class Mys0004Spider(GGVenturesSpider):
    name = 'mys_0004'
    start_urls = ['https://business.utm.my/']
    country = "Malaysia"
    ...
    static_name = "Universiti Teknologi Malaysia,International Business School (IBS)"
    static_logo = "http://business.utm.my/wp-content/uploads/2018/08/AHIBS-Logo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://business.utm.my/events/"

    university_contact_info_xpath = "//div[contains(@class,'et_pb_section_4')]"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            self.check_website_changed(upcoming_events_xpath="//li[contains(text(),'no upcoming')]")
