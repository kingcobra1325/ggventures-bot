...
class Kgz0001Spider(GGVenturesSpider):
    name = 'kgz_0001'
    start_urls = ['https://www.auca.kg/en/contacts/']
    country = "Kyrgyzstan"
    ...
    static_name = "American University of Central Asia"
    static_logo = "https://www.auca.kg/templates/_sources/logo_tr2.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.auca.kg/en/auca_events/"

    university_contact_info_xpath = "//h1[text()='AUCA Contacts']/parent::div"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//a[contains(@class,'eventslink')]"):
