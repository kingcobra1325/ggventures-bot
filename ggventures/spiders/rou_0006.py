...
class Rou0006Spider(GGVenturesSpider):
    name = 'rou_0006'
    start_urls = ['https://feaa.uvt.ro/en/contact']
    country = "Romania"
    ...
    static_name = "University of West Timisoara,Faculty of Economics Sciences"
    static_logo = "https://feaa.uvt.ro/images/theme/FEAA-logo.svg"
