...
class Usa0020Spider(GGVenturesSpider):
    name = 'usa_0020'
    start_urls = ["https://www.johnson.cornell.edu/"]
    country = 'US'
    eventbrite_id = 34238387695

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Cornell University,Samuel Curtis Johnson Graduate School of Management"
    
    static_logo = "https://www.johnson.cornell.edu/wp-content/themes/core/img/theme/logos/johnson-logo.svg"
