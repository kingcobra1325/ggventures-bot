...
class Tha0006Spider(GGVenturesSpider):
    name = 'tha_0006'
    start_urls = ["https://www.fms.psu.ac.th/contact-us/?lang=en"]
    country = 'Thailand'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Prince of Songkla University,Faculty of Management Sciences"
    
    static_logo = "https://www.fms.psu.ac.th/wp-content/uploads/2020/03/FMS_Logo_Header_EN.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.fms.psu.ac.th/?lang=en"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            self.Mth.WebDriverWait(self.driver, 10).until(self.Mth.EC.frame_to_be_available_and_switch_to_it((self.Mth.By.XPATH,"//div[@class='wpb_wrapper']/iframe")))
