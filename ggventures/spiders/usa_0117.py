...
class Usa0117Spider(GGVenturesSpider):
    name = 'usa_0117'
    start_urls = ["https://business.louisville.edu/contact-us/"]
    country = 'US'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "University of Louisville, College of Business and Public Administration"
    
    static_logo = "https://louisville.edu/online/-/images/pages/mba/logo-COB_fullcolor.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://events.louisville.edu/search/events?search=Business"

    university_contact_info_xpath = "//div[@class='footer__map']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//h3[@class='summary']/a"):
                ...
                if self.unique_event_checker(url_substring=["https://events.louisville.edu/event/"]):
