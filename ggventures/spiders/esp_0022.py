...
class Esp0022Spider(GGVenturesSpider):
    name = 'esp_0022'
    start_urls = ["https://www.deusto.es/es/inicio/contacto"]
    country = 'Spain'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Universidad de Deusto,ESTE - Facultad de Ciencias Económicas y Empresariales"
    
    static_logo = "https://www.deusto.es/estaticos/ud/img/logoDeustoMenu.png"
