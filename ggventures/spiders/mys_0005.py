...
class Mys0005Spider(GGVenturesSpider):
    name = 'mys_0005'
    start_urls = ['http://www.uum.edu.my/index.php/main-contact']
    country = "Malaysia"
    ...
    static_name = "Universiti Utara Malaysia (UUM)"
    static_logo = "http://www.uum.edu.my/images/Universiti_Utara_Malaysia.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "http://www.uum.edu.my/"

    university_contact_info_xpath = "//div[@id='sp-component']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            self.check_website_changed(upcoming_events_xpath="//div[@id='sppb-addon-wrapper-1544276894431']",empty_text=True)
