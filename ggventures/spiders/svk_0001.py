...
class Svk0001Spider(GGVenturesSpider):
    name = 'svk_0001'
    start_urls = ['https://www.fm.uniba.sk/en/about-faculty/contact/']
    country = "Slovakia"
    ...
    static_name = "Comenius University,Faculty of Management"
    static_logo = "https://en.gaudeamus.cz/getFile/type:large/id:531737/FM_logo_text_BP_horizontal.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://uniba.sk/en/comenius-university-news/events/"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//h2/a"):
                ...
                if self.unique_event_checker(url_substring=['uniba.sk/en/news-detail']):
                    ...
                    item_data['event_desc'] = self.getter.find_element(self.Mth.By.XPATH,"//div[contains(@class,'default')]").text
                    # try:
                    ...
                    item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//div[contains(@class,'default')]").text
                    item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//div[contains(@class,'default')]").text
