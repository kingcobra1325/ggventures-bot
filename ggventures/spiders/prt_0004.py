...
class Prt0004Spider(GGVenturesSpider):
    name = 'prt_0004'
    start_urls = ['https://www.ucp.pt/contacts-headquarters-and-regional-centres']
    country = "Portugal"
    ...
    static_name = "Universidade Catolica Portuguesa,Faculdade de Ciências Económicas e Empresariais"
    static_logo = "https://upload.wikimedia.org/wikipedia/commons/0/0e/UCP_Logo.png"
