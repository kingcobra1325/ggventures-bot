...
class Rus0019Spider(GGVenturesSpider):
    name = 'rus_0019'
    start_urls = ["https://eng.vvsu.ru/contacts/"]
    country = 'Russia'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Vladivostok State University of Economics and Service,The Institute of Management Business and Economics"
    
    static_logo = "https://www.edarabia.com/wp-content/uploads/2019/01/vladivostok-state-university-economics-service-vladivostok-russia.jpg"
