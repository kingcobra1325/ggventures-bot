...
class Mdg0001Spider(GGVenturesSpider):
    name = 'mdg_0001'
    start_urls = ['https://www.iscam.mg/']
    country = "Madagascar"
    ...
    static_name = "ISCAM - Institut Supérieur de la Communication des Affaires et du Management"
