...
class Usa0146Spider(GGVenturesSpider):
    name = 'usa_0146'
    start_urls = ["https://www1.villanova.edu/villanova/contact.html"]
    country = 'US'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Villanova University,Villanova School of Business"
    
    static_logo = "https://www1.villanova.edu/content/dam/villanova/logos/university-main-logo-1.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://calendar.utk.edu/calendar"

    university_contact_info_xpath = "//div[starts-with(@class,'pagecontent')]"
