...
class Ken0004Spider(GGVenturesSpider):
    name = 'ken_0004'
    start_urls = ['https://business.uonbi.ac.ke/']
    country = "Kenya"
    ...
    static_name = "University of Nairobi,School of Business"
    static_logo = "https://business.uonbi.ac.ke/sites/default/files/best-logo59_0.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://business.uonbi.ac.ke/events"

    university_contact_info_xpath = "//h2[text()='contacts']/following-sibling::div"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//div[@id='main']//div[contains(@class,'views-field-title')]/a"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=['business.uonbi.ac.ke/event']):
