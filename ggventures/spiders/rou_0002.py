...
class Rou0002Spider(GGVenturesSpider):
    name = 'rou_0002'
    start_urls = ['https://www.ubbcluj.ro/en/facultati/business']
    country = "Romania"
    ...
    static_name = "Babes-Bolyai University,Transylvania Business School"
    static_logo = "https://www.ubbcluj.ro/img/Logo-UBB.svg"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//h3[contains(@class,'entry-title')]/a"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=['www.asebuss.ro']):

                    self.Func.print_log(f"Currently scraping --> {self.getter.current_url}","info")

                    item_data = self.item_data_empty.copy()

                    item_data['event_name'] = self.Mth.WebDriverWait(self.getter,20).until(self.Mth.EC.presence_of_element_located((self.Mth.By.XPATH,"//h1/a"))).text
