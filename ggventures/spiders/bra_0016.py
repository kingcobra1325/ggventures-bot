...
class Bra0016Spider(GGVenturesSpider):
    name = 'bra_0016'
    start_urls = ["http://www.ufrgs.br/ufrgs/inicial"]
    country = 'Brazil'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Universidade Federal do Rio Grande do Sul"
    
    static_logo = "http://www.ufrgs.br/ufrgs/logo.jpg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.ufpr.br/portalufpr/mais-eventos/"

    university_contact_info_xpath = "//div[@id='arearodape']"
