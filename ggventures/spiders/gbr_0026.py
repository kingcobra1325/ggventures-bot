...
class Gbr0026Spider(GGVenturesSpider):
    name = "gbr_0026"
    start_urls = ["https://www.brookes.ac.uk/business/about/contact"]
    country = "United Kingdom"
    eventbrite_id = 30147489468
# 
    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Oxford Brookes University,Business School"
    
    static_logo = "https://www.brookes.ac.uk/getmedia/9a341f12-505e-449b-a909-ff40965ec53f/obbs-logo.svg?ext=.svg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.su.se/stockholm-business-school/calendar"

    university_contact_info_xpath = "(//div[@class='columns'])[1]"
