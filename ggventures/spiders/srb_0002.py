...
class Srb0002Spider(GGVenturesSpider):
    name = 'srb_0002'
    start_urls = ['http://www.bg.ac.rs/en/members/faculties/FE.php']
    country = "Serbia"
    ...
    static_name = "University of Belgrade,Faculty of Economics"
    static_logo = "https://freemarket-rs.com/wp-content/uploads/2019/01/1.png"
