...
class Kor0001Spider(GGVenturesSpider):
    name = 'kor_0001'
    start_urls = ["https://www.ust.edu.ph/contacts/"]
    country = 'South Korea'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Chonbuk National University,Graduate School of Business Administration"
