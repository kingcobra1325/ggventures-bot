...
class Ind0032Spider(GGVenturesSpider):
    name = 'ind_0032'
    start_urls = ["https://www.nmims.edu/contact"]
    country = 'India'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Narsee Monjee Institute of Management Studies (NMIMS)"
    
    static_logo = "https://www.nmims.edu/images/nmims-university-logo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://spandan.nmims.edu/category/events/"

    university_contact_info_xpath = "//span[@class='c-icon']/ancestor::div[@class='row']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="(//div[@class='td-block-span6'] | //div[@class='td-category-grid'])//div[@class='td-module-thumb']/a"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=["https://spandan.nmims.edu/"]):
