...
class Ind0029Spider(GGVenturesSpider):
    name = 'ind_0029'
    start_urls = ["https://www.slbsrsv.ac.in/contactus"]
    country = 'India'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Lal Bahadur Shastri"
    
    static_logo = "https://www.slbsrsv.ac.in/sites/default/files/uploadfiles/slbs-logo-may1.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.slbsrsv.ac.in/news-events"

    university_contact_info_xpath = "//div[@class='contact-us']"
