...
class Pan0001Spider(GGVenturesSpider):
    name = 'pan_0001'
    start_urls = ['https://usma.ac.pa/']
    country = "Panama"
    ...
    static_name = "Universidad Católica Santa María La Antigua (USMA),Facultad de Ciencias Administrativas"
    static_logo = "https://i0.wp.com/usma.ac.pa/wp-content/uploads/2020/02/2019-NUEVO-COLOR-LOGO-HORIZONTAL-OFICIAL-ESCUDO-USMA-1.png?w=800&ssl=1"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            self.check_website_changed(upcoming_events_xpath="//td[contains(@class,'tribe-events')]//a",checking_if_none=True)
            ...
            #     if self.unique_event_checker(url_substring=['events.umt.edu.pk']):
            #
            ...
            #         item_data['event_desc'] = self.getter.find_element(self.Mth.By.XPATH,"//div[contains(@class,'description')]").text
            #         # try:
            #         #     item_data['event_desc'] = self.getter.find_element(self.Mth.By.XPATH,"//div[contains(@class,'event-desc')]").text
            #         # except self.Exc.NoSuchElementException as e:
            #         #     self.Func.print_log(f"XPATH not found {e}: Skipping.....",'debug')
            #
            #         item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//div[contains(@class,'detail-container')]").text
            #         item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//div[contains(@class,'detail-container')]").text
            #
