...
class Lbn0001Spider(GGVenturesSpider):
    name = 'lbn_0001'
    start_urls = ['https://www.aub.edu.lb/Pages/ContactUs.aspx']
    country = "Lebanon"
    ...
    static_name = "American University of Beirut,Suliman S. Olayan School of Business (OSB)"
    static_logo = "https://aubcdn.azureedge.net/aubwebsite/AUB/images/logo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.aub.edu.lb/osb/Events/Pages/default.aspx"

    university_contact_info_xpath = "//div[@class='layout-free-text-content']"
