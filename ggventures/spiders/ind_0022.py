...
class Ind0022Spider(GGVenturesSpider):
    name = 'ind_0022'
    start_urls = ["https://iilm.edu/#"]
    country = 'India'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Institute for Integrated Learning in Management (IILM)"
    
    static_logo = "https://iilm.edu/demo2020/wp-content/uploads/2020/06/iilmu-logo-light.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://iilm.edu/events/list/"

    university_contact_info_xpath = "//div[starts-with(@class,'kingster-top-bar-left')]"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//h3[starts-with(@class,'tribe-events-calendar-list__event-title')]/a"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=["https://iilm.edu/event/"]):
