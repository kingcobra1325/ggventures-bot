...
class Kor0013Spider(GGVenturesSpider):
    name = 'kor_0013'
    start_urls = ["https://isbs.sogang.ac.kr/isbs/isbs01_5_3.html"]
    country = 'South Korea'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Sogang University,School of Business"
    
    static_logo = "https://isbs.sogang.ac.kr/isbs/images/title/1622_1.png"
