...
class Col0004Spider(GGVenturesSpider):
    name = 'col_0004'
    start_urls = ['https://www.eafit.edu.co/institucional/contacto/Paginas/contacto-eafit.aspx']
    country = "Colombia"
    ...
    static_name = "Universidad EAFIT,Escuela de Administración"
    static_logo = "https://www.eafit.edu.co/SiteCollectionImages/logo.png"
