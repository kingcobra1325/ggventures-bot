...
class Usa0041Spider(GGVenturesSpider):
    name = 'usa_0041'
    start_urls = ["https://www.lsu.edu/about/requestinfo.php"]
    country = 'US'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Louisiana State University,E. J. Ourso College of Business"
    
    static_logo = "https://economist-findercms-files.s3.us-west-1.amazonaws.com/2018-11/oursolg01.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.lsu.edu/business/newsevents/calendar.php"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//div[@class='lw']//span[@class='lwn0']/../a"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=["https://calendar.lsu.edu/event"]):
