...
class Swe0007Spider(GGVenturesSpider):
    name = 'swe_0007'
    start_urls = ["https://www.umu.se/en/contact-us/"]
    country = 'Sweden'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Umeå University,Umeå School of Business"
    
    static_logo = "https://www.umu.se/globalassets/_centralt-innehall/logotyper/handelshogskolan-web-en.svg"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//a[@class='eventlink']"):
                ...
                if self.unique_event_checker(url_substring=["https://www.umu.se/en/events/"]):
                    ...
                    item_data['event_desc'] = self.desc_images(desc_xpath="//div[starts-with(@class,'eventText')]")
                    ...
                    try:
                        item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//span[@class='durationDay']").get_attribute('textContent')
                        item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//span[@class='durationTime']").get_attribute('textContent')
