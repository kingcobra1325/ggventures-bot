...
class Chl0002Spider(GGVenturesSpider):
    name = 'chl_0002'
    start_urls = ['https://escueladeadministracion.uc.cl/']
    country = "Chile"
    ...
    static_name = "Pontificia Universidad Católica de Chile,Escuela de Administración"
    static_logo = "https://escueladeadministracion.uc.cl/wp-content/uploads/2022/04/santiago-1-1280x550.png"
