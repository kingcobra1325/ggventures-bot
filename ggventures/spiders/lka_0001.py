...
class Lka0001Spider(GGVenturesSpider):
    name = 'lka_0001'
    start_urls = ['https://mgmt.cmb.ac.lk/contact-us']
    country = "Sri Lanka"
    ...
    static_name = "University of Colombo,Faculty of Management and Finance"
    static_logo = "https://mgmt.cmb.ac.lk/wp-content/uploads/2016/03/Uoc_FMF_New-1.jpg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://mgmt.cmb.ac.lk/event"
