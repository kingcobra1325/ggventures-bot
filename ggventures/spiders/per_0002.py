...
class Per0002Spider(GGVenturesSpider):
    name = 'per_0002'
    start_urls = ['https://pad.edu/']
    country = "Peru"
    ...
    static_name = "Universidad de Piura - PAD,Escuela de Dirección"
    static_logo = "https://pad.edu/wp-content/uploads/2020/02/LogoPAD_blanco_web.png"
