...
class Ita0013Spider(GGVenturesSpider):
    name = 'ita_0013'
    start_urls = ["http://www.stoa.it/sito/contacts/?lang=en"]
    country = 'Italy'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "STOA',Istituto di Studi per la Direzione e Gestione di Impresa"
    ...
    university_contact_info_xpath = "(//div[@class='elementor-row'])[6]"
