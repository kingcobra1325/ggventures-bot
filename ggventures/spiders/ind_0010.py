...
class Ind0010Spider(GGVenturesSpider):
    name = 'ind_0010'
    start_urls = ["https://www.icfaiuniversity.in/contact.html"]
    country = 'India'
    ...
    static_logo = "https://dlpindia.com/blog/wp-content/uploads/2018/01/icfai-group-logo.jpg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://gim.ac.in/institute/events"

    university_contact_info_xpath = "//main//div[@class='tab-content']"
