...
class Tha0005pider(GGVenturesSpider):
    name = 'tha_0005'
    start_urls = ["https://mba.kku.ac.th/th/content.php?name=contact"]
    country = 'Thailand'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Khon Kaen University,College of Graduate Study in Management"
    
    static_logo = "https://mba.kku.ac.th/th/img/web_title_sm.png"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            self.check_website_changed(upcoming_events_xpath="//td[text()='No event found']",empty_text=False)
