...
class Est0002Spider(GGVenturesSpider):
    name = 'est_0002'
    start_urls = ['https://taltech.ee/en/contacts']
    country = "Estonia"
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404,429]

    static_name = "Tallinn University of Technology,School of Economics and Business Administration"
    static_logo = "https://taltech.ee/static/taltech-logo-cutout.svg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://taltech.ee/en/events"
