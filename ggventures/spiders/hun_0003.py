...
class Hun0003Spider(GGVenturesSpider):
    name = 'hun_0003'
    start_urls = ['https://www.uni-corvinus.hu/?lang=en']
    country = "Hungary"
    ...
    static_name = "Corvinus University of Budapest,Faculty of Business Administration"
    static_logo = "https://ft-bschool-rankings.s3.eu-west-2.amazonaws.com/production/images/0b716727-519e-4331-9653-c48cb309abe2-348438cec07b4f0e9b557e099516a56a"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.uni-corvinus.hu/main-page/news-and-events/events/?lang=en"

    university_contact_info_xpath = "//div[contains(@class,'center-col')]/following-sibling::div"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//div[@class='event__content']/a"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=['www.uni-corvinus.hu/post/event']):
                    ...
                    item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='event__meta']").text
                    item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='event__meta']").text
