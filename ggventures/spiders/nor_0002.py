...
class Nor0002Spider(GGVenturesSpider):
    name = 'nor_0002'
    start_urls = ['https://www.nhh.no/en/about-nhh/contact/']
    country = "Norway"
    ...
    static_name = "Norwegian School of Economics and Business Administration,NHH - Norges Handelshøyskole"
