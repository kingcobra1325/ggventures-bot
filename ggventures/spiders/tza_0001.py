...
class Tza0001Spider(GGVenturesSpider):
    name = 'tza_0001'
    start_urls = ['https://www.udsm.ac.tz/web/index.php/site/contact-us']
    country = "Tanzania"
    ...
    static_name = "University of Dar es Salaam,Faculty of Management and Commerce"
    static_logo = "https://www.udsm.ac.tz/web/themes/udsm/layouts/main/img/logo_ud.png"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//h2/a"):
                ...
                if self.unique_event_checker(url_substring=['www.udsm.ac.tz/web/index.php/events']):
                    ...
                    item_data['event_desc'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='news-content']").text
                    # try:
