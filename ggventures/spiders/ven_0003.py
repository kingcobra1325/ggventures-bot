...
class Ven0003Spider(GGVenturesSpider):
    name = 'ven_0003'
    start_urls = ["http://www.ula.ve/ciencias-economicas-sociales/index.php/contactenos"]
    country = 'Venezuela'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Universidad de Los Andes - Venezuela,Facultad de Ciencias Económicas y Sociales"
    
    static_logo = "http://www.ula.ve/ciencias-economicas-sociales/images/img_faces/logo_faces.png"
