...
class Kwt0001Spider(GGVenturesSpider):
    name = 'kwt_0001'
    start_urls = ['https://www.auk.edu.kw/cbe/contact-us']
    country = "Kuwait"
    ...
    static_name = "American University of Kuwait (AUK)"
    static_logo = "https://www.auk.edu.kw/AUK/media/images/cbe.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.auk.edu.kw/pathways/alumni/about-auk/calendars"

    university_contact_info_xpath = "//div[@class='inside-main']"
