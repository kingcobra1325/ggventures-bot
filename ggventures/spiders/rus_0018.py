...
class Rus0018Spider(GGVenturesSpider):
    name = 'rus_0018'
    ...
    static_name = "Urals State University,Institute for Retraining Specialists"
    
    static_logo = "https://upload.wikimedia.org/wikipedia/en/6/66/USTU_logo.jpg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://urfu.ru/ru/events/s"

    university_contact_info_xpath = "//div[contains(@class,'main-contacts')]"
