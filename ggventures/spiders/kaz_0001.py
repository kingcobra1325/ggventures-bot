...
class Kaz0001Spider(GGVenturesSpider):
    name = 'kaz_0001'
    start_urls = ['https://iab.academy/']
    country = "Kazakhstan"
    ...
    static_name = "IAB - International Academy of Business"
    static_logo = "https://iab.academy/wp-content/uploads/2020/08/IAB_logo.svg"
