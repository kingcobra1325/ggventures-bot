...
class Zaf0016Spider(GGVenturesSpider):
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            self.driver.find_element(self.Mth.By.XPATH,"//div[text()='Events']").click()
    
            self.check_website_changed(upcoming_events_xpath="//h4[text()='No upcoming events ']",empty_text=False)
