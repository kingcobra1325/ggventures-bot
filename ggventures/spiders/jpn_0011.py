...
class Jpn0011Spider(GGVenturesSpider):
    name = 'jpn_0011'
    start_urls = ["https://www.econ.kyushu-u.ac.jp/english/other/inquiry/"]
    country = 'Japan'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Kyushu University,Faculty of Economics"
    
    static_logo = "https://www.econ.kyushu-u.ac.jp/wp-content/themes/keizaigakubu/img/Eng/common/gl_logo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.econ.kyushu-u.ac.jp/english/syllabus/forthcoming_events/"

    university_contact_info_xpath = "//div[@class='contentsMain']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//ul[@class='newsLinks']//li/a"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=["https://www.econ.kyushu-u.ac.jp/"]):
                    ...
                    item_data['event_desc'] = self.desc_images(desc_xpath="//div[@class='txt noIndent']")

                    item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='txt noIndent']").get_attribute('textContent')
                    item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='txt noIndent']").get_attribute('textContent')
