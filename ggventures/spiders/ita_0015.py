...
class Ita0015Spider(GGVenturesSpider):
    name = 'ita_0015'
    start_urls = ["https://www.economia.unifi.it/p360.html"]
    country = 'Italy'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Università degli Studi di Firenze,Facoltà di Economia"
    
    static_logo = "https://assets.unifi.it/prod/economia.unifi.it/banner_nero.svg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://businessschool.luiss.it/en/news-events/calendar/"

    university_contact_info_xpath = "//div[@id='anagrafica']"
