...
class Ita0012Spider(GGVenturesSpider):
    name = 'ita_0012'
    start_urls = ["https://www.sdabocconi.it/en/contact-us"]
    country = 'Italy'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "SDA Bocconi,School of Managament"
    
    static_logo = "https://www.sdabocconi.it/fe-web/img/general/header_sdab_logo.svg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://businessschool.luiss.it/en/news-events/calendar/"

    university_contact_info_xpath = "//p[text()='You can also contact us by:']/.."
