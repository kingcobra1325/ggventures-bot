...
class Lva0002Spider(GGVenturesSpider):
    name = 'lva_0002'
    start_urls = ['https://www.rbs.lv/rbscontacts']
    country = "Latvia"
    ...
    static_name = "Riga Business School"
    static_logo = "https://www.rbs.lv/files/rbs/content-images/logo/RBS2022.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.rbs.lv/calendar"

    university_contact_info_xpath = "//div[@class='left-corner']"
        ...
        ####################
            ...
            # for link in self.events_list(event_links_xpath="//h3[@class='news_list']/a"):
                ...
                if self.unique_event_checker(url_substring=['www.rbs.lv/events']):
                    ...
                    item_data['event_name'] = self.Mth.WebDriverWait(self.getter,20).until(self.Mth.EC.presence_of_element_located((self.Mth.By.XPATH,"//div[@class='left-corner']/h1"))).text
                    item_data['event_desc'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@id='sec_level_page']").get_attribute('textContent')
                    # try:
                    ...
                    item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//span[@class='date-display-single']").get_attribute('textContent')
                    item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//span[@class='date-display-single']").get_attribute('textContent')
