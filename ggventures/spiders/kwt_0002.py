...
class Kwt0002Spider(GGVenturesSpider):
    name = 'kwt_0002'
    start_urls = ['http://www.msm-kuwait.com/contact/']
    country = "Kuwait"
    ...
    static_name = "Kuwait Maastricht Business School"
    static_logo = "http://www.msm-kuwait.com/wp-content/uploads/2017/11/msm-kuwait-logo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "http://www.msm-kuwait.com/category/news-events/"

    university_contact_info_xpath = "//div[@class='contact-info']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//h4/a"):
                ...
                if self.unique_event_checker(url_substring=['www.auk.edu.kw/footer-menu/calendars']):
                    ...
                    item_data['event_desc'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='event-details']").text
                    # try:
                    ...
                    item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='event-details']").text
                    item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='event-details']").text
