...
class Pry0001Spider(GGVenturesSpider):
    name = 'pry_0001'
    start_urls = ['https://www.edan.edu.py/contacto']
    country = "Paraguay"
    ...
    static_name = "EDAN - Escuela de Administracion de Negocios"
    static_logo = "https://www.edan.edu.py/uploads/images/logo.png"
