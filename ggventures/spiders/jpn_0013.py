...
class Jpn0013Spider(GGVenturesSpider):
    name = 'jpn_0013'
    start_urls = ["https://www.nucba.ac.jp/en/contact/"]
    country = 'Japan'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Nagoya University of Commerce & Business (NUCB)"
    
    static_logo = "https://gbsn.org/wp-content/uploads/2019/12/Nagoya-University-of-Commerce-Business-logo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.nucba.ac.jp/en/event/"

    university_contact_info_xpath = "//div[@class='p-footer__flex-contents-left']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//a[@class='c-thumbnail-list__title-inner']"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=["https://www.nucba.ac.jp/en/event/"]):
                    ...
                    item_data['event_desc'] = self.desc_images(desc_xpath="//div[@class='acms-grid']")

                    item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//time/..").get_attribute('textContent')
                    item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//time/..").get_attribute('textContent')
