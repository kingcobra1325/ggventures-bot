...
class Esp0005Spider(GGVenturesSpider):
    name = 'esp_0005'
    start_urls = ["https://een.edu/contacto/"]
    country = 'Spain'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "EEN - Escuela Europea de Negocios"
    
    static_logo = "https://een.edu/wp-content/uploads/2018/12/logoeen.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.sysu.edu.cn/en/news/news01/index.htm"

    university_contact_info_xpath = "(//div[@class='elementor-section-wrap'])[2]"
