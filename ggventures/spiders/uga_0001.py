...
class Uga0001Spider(GGVenturesSpider):
    name = 'uga_0001'
    start_urls = ['https://mubs.ac.ug/contact-us/']
    country = "Uganda"
    ...
    static_name = "Makerere University Business School (MUBS)"
    static_logo = "https://www.ugandainvest.go.ug/wp-content/uploads/2016/05/MUBS-logo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://mubs.ac.ug/events/list/"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//header[@class='tribe-events-calendar-list__event-header']//h3/a"):
                ...
                if self.unique_event_checker(url_substring=['mubs.ac.ug/event']):
                    ...
                    item_data['event_desc'] = self.scrape_xpath(xpath_list=["//div[contains(@class,'tribe-events-single-event-description')]"])
                    item_data['event_date'] = self.scrape_xpath(xpath_list=["//dl"],method='attr')
                    item_data['event_time'] = self.scrape_xpath(xpath_list=["//dl"],method='attr')
