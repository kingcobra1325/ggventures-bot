...
class Kor0006Spider(GGVenturesSpider):
    name = 'kor_0006'
    start_urls = ["https://www.business.kaist.edu/html/kgsm_en/sub01/sub01_0103.html"]
    country = 'South Korea'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "KAIST Graduate School of Management (KGSM)"
    
    static_logo = "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0a/KAIST_logo.svg/175px-KAIST_logo.svg.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.business.kaist.edu/_prog/seminar/index.php?site_dvs_cd=kgsm_en&menu_dvs_cd=060203&func_dvs_cd=event&yearall=all"

    university_contact_info_xpath = "//div[@id='txt']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            self.check_website_changed(upcoming_events_xpath="//section[@id='list_semina']/p[text()='No Data']")
