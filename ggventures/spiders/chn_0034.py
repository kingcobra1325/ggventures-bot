...
class Chn0034Spider(GGVenturesSpider):
    name = 'chn_0034'
    start_urls = ["http://www.chinadaily.com.cn/m/shanxi/shanxiuniversity/2021-02/26/content_18914060.htm"]
    country = 'China'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Shanxi University"
    
    static_logo = "https://www.sxu.edu.cn/images/indexlogo.jpg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://newsen.pku.edu.cn/activity.html"

    university_contact_info_xpath = "//div[@class='art']"
