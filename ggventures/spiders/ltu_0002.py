...
class Ltu0002Spider(GGVenturesSpider):
    name = 'ltu_0002'
    start_urls = ['http://www.vu.lt/en/studies/bachelor-and-integrated-studies/international-business/']
    country = "Lithuania"
    ...
    static_name = "International Business School at Vilnius University"
    static_logo = "https://www.vu.lt/site_files/logo_vu_en_baltas_text.svg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.vu.lt/en/news-events/events"

    university_contact_info_xpath = "//div[@id='gkFooterNav']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//a[@class='block-link']"):
                ...
                if self.unique_event_checker(url_substring=['www.vu.lt/en/news-events/events']):
                    ...
                    item_data['event_desc'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='itemBody']").text
                    # try:
                    #     item_data['event_desc'] = self.getter.find_element(self.Mth.By.XPATH,"//div[contains(@class,'event-desc')]").text
                    # except self.Exc.NoSuchElementException as e:
                    #     self.Func.print_log(f"XPATH not found {e}: Skipping.....",'debug')

                    item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='itemBody']").text
                    item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='itemBody']").text
