...
class Zaf0015Spider(GGVenturesSpider):
    name = 'zaf_0015'
    start_urls = ["https://www.ul.ac.za/tgsl/index.php?Entity=Contact%20Us"]
    country = 'South Africa'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "University of Limpopo,Turfloop Graduate School of Leadership"
    ...
    university_contact_info_xpath = "//tr[@class='PAGEContent']/ancestor::tr"
