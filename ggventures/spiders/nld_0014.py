...
class Nld0014Spider(GGVenturesSpider):
    name = 'nld_0014'
    start_urls = ['https://vu.nl/en/about-vu/more-about/contact']
    country = "Netherlands"
    ...
    static_name = "Vrije Universiteit Amsterdam"
    static_logo = "https://vu.nl/assets/images/VU-logo-nobg.svg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://vu.nl/en/events"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//div[@class='vuw-card-search']/parent::a"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=['vu.nl/en/events']):
                    ...
                    item_data['event_desc'] = self.scrape_xpath(xpath_list=["//div[@class='vuw-container']//article"],method='attr')
                    item_data['event_date'] = self.scrape_xpath(xpath_list=["//h1[@class='vuw-h2']"])
                    item_data['event_time'] = self.scrape_xpath(xpath_list=["//h1[@class='vuw-h2']"])
