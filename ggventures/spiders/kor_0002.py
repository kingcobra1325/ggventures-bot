...
class Kor0002Spider(GGVenturesSpider):
    name = 'kor_0002'
    start_urls = ["https://cba.jnu.ac.kr/cba_eng/13977/subview.do"]
    country = 'South Korea'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Chonman National University,College of Business Administration"
    
    static_logo = "https://cba.jnu.ac.kr/sites/cba_eng/images/common/logo_w.png"
