...
class Can0021Spider(GGVenturesSpider):
    name = "can_0021"
    start_urls = ["https://www.edwards.usask.ca/contact.aspx"]
    country = "Canada"
    eventbrite_id = 31060605851

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "University of Saskatchewan,Edwards School of Business"
    
    static_logo = "https://www.edwards.usask.ca/img/logos/edwards_sm-white.jpg"
