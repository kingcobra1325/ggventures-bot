...
class Pol0011Spider(GGVenturesSpider):
    name = 'pol_0011'
    start_urls = ["https://www.wsz.pl/kontakt/"]
    country = 'Poland'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "WSZ - Gdansk Management College"
    
    static_logo = "https://www.wsz.pl/wp-content/themes/wsz/img/xlogo-ua.png.pagespeed.ic.xiT4QNm30Q.webp"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.econ.umk.pl/en/calendar/"

    university_contact_info_xpath = "//div[@class='entry']"
