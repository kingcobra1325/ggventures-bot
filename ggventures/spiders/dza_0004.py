...
class Dza0004Spider(GGVenturesSpider):
    name = 'dza_0004'
    start_urls = ['https://fsecg.univ-alger3.dz/']
    country = "Algeria"
    ...
    static_name = "Université d'Alger,Faculté des Sciences Economiques et de Gestion"
    static_logo = "https://www.esaa.dz/wp-content/uploads/2016/08/logo-site-new-retina-blanc.png"
