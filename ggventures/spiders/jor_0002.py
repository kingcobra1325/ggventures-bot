...
class Jor0002Spider(GGVenturesSpider):
    name = 'jor_0002'
    start_urls = ['http://business.ju.edu.jo/Pages/ContactUs.aspx']
    country = "Jordan"
    ...
    static_name = "The University of Jordan,Faculty of Business Administration"
