...
class Col0008Spider(GGVenturesSpider):
    name = 'col_0008'
    start_urls = ['https://www.unisimon.edu.co/servicios/directorio']
    country = "Colombia"
    ...
    static_name = "Universidad Simon Bolivar"
    static_logo = "https://www.unisimon.edu.co/recursos/img/unisimon-logo-50-year.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.unisimon.edu.co/eventos"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            #     if self.unique_event_checker(url_substring=['universidadean.edu.co/eventos']):
