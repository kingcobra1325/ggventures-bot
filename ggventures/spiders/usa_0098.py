...
class Usa0098Spider(GGVenturesSpider):
    name = 'usa_0098'
    start_urls = ["https://www.uab.edu/home/contact"]
    country = 'US'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "University of Alabama at Birmingham,School of Business"
    
    static_logo = "https://www.uab.edu/icorps/images/Logos/color-without-R-centered_500.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://calendar.uab.edu/calendar"

    university_contact_info_xpath = "//div[@itemprop='articleBody']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//h3[@class='summary']/a"):
                ...
                if self.unique_event_checker(url_substring=["https://calendar.uab.edu/event/"]):
