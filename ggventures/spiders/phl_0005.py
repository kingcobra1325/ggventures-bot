...
class Phl0005Spider(GGVenturesSpider):
    name = 'phl_0005'
    ...
    static_name = "University of Santo Tomas,UST Graduate School"
    
    static_logo = "https://www.ust.edu.ph/wp-content/uploads/2021/04/ustlogoedited.png"
