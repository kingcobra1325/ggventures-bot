...
class Tur0007Spider(GGVenturesSpider):
    name = 'tur_0007'
    start_urls = ["https://sbe.marmara.edu.tr/en/contact"]
    country = 'Turkey'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Marmara University,Institute of Social Sciences"
    
    static_logo = "https://sbe.marmara.edu.tr/_assets/marmara/custom/images/mar_logo_en.png?v=1.1"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.marmara.edu.tr/en/allevents"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            self.check_website_changed(upcoming_events_xpath="//div[starts-with(@class,'col-md-9')]",empty_text=True)
