...
class Phl0002Spider(GGVenturesSpider):
    ...
    static_name = "Ateneo de Manila University,Graduate School of Business"
    
    static_logo = "https://gsb.ateneo.edu/wp-content/themes/ateneo/css/images/official-logo.png"
