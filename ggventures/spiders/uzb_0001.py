...
class Uzb0001Spider(GGVenturesSpider):
    name = 'uzb_0001'
    start_urls = ['https://www.unipage.net/en/21888/international_business_school_kelajak_ilmi/']
    country = "Uzbekistan"
    ...
    static_name = "International Business School Kelajak Ilmi"
