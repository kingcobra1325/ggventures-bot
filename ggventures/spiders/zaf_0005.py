...
class Zaf0005Spider(GGVenturesSpider):
    name = 'zaf_0005'
    start_urls = ["http://businessschool.mandela.ac.za/contact-us"]
    country = 'South Africa'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Nelson Mandela Metropolitan University,Business School"
    ...
    university_contact_info_xpath = "//div[@class='right_column']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            self.check_website_changed(upcoming_events_xpath="//p[text()='There are currently no events to dispay, please come back soon.']",empty_text=False)
