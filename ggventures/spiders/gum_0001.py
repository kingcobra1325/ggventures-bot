...
class Gum0001Spider(GGVenturesSpider):
    name = 'gum_0001'
    start_urls = ['https://www.uog.edu/contact-us']
    country = "Guam"
    ...
    static_name = "University of Guam,School of Business & Public Administration"
    static_logo = "https://www.uog.edu/_resources/css/sites/default/files/2018-UOG-BigG-Horizontal-CMYK-TRITON-GREEN-compressor.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.uog.edu/calendar/"

    university_contact_info_xpath = "//div[@id='pagearea-minisites']"
