...
class Isr0004Spider(GGVenturesSpider):
    name = 'isr_0004'
    start_urls = ['https://www-e.openu.ac.il/academic/management/contact.html']
    country = "Israel"
    ...
    static_name = "Open University of Israel,Department of Management and Economics"
    static_logo = "https://www-e.openu.ac.il/academic/management/gifs/header.gif"
