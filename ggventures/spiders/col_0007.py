...
class Col0007Spider(GGVenturesSpider):
    name = 'col_0007'
    start_urls = ['https://universidadean.edu.co/contacto']
    country = "Colombia"
    ...
    static_name = "Universidad EAN"
    static_logo = "https://universidadean.edu.co/sites/default/files/logo-horizontal-es.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://universidadean.edu.co/eventos"
