...
class Esp0006Spider(GGVenturesSpider):
    name = 'esp_0006'
    start_urls = ["https://www.eoi.es/contacto"]
    country = 'Spain'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "EOI Business School"
    
    static_logo = "https://www.eoi.es/sites/default/files/logo-eoi.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.eoi.es/es/agenda-0"

    university_contact_info_xpath = "//li[contains(@class,'phone')]"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="(//table[starts-with(@class,'views-table')])[1]/tbody/tr/td[1]/a"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=["https://www.eoi.es/es/eventos/","https://www.eoi.es/es/clubeoi/eventos/"]):
