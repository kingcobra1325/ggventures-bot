    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//div[@class='card-header']/a"):
                ...
                if self.unique_event_checker(url_substring=["https://events.blackthorn.io/en/","https://www.whu.edu/en/programs/"]):
                    ...
                    item_data['event_desc'] = self.getter.find_element(self.Mth.By.XPATH,"//div/div/p | //div[@class='content']").text

                    # item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//div[contains(@class,'inner-box information')]").get_attribute('textContent')
                    # item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//div[contains(@class,'inner-box information')]").get_attribute('textContent')

                    try:
                        item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//h4[contains(text(),'When')]/following-sibling::p | //*[starts-with(@class,'event-start-end-date')] | //div[@id='c207268']").get_attribute('textContent')
                        item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//h4[contains(text(),'When')]/following-sibling::p | //*[starts-with(@class,'event-start-end-date')] | //div[@id='c207268']").get_attribute('textContent')
