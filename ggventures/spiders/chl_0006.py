...
class Chl0006Spider(GGVenturesSpider):
    name = 'chl_0006'
    start_urls = ['https://www.postgradouchile.cl/programa/talleres-alumni/topicos-avanzados-de-finanzas-valoracion-de-empresas-y-carteras-de-inversion/']
    country = "Chile"
    ...
    static_name = "Universidad de Chile,Escuela de Postgrado Economía y Negocios"
