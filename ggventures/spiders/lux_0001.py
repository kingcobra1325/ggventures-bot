...
class Lux0001Spider(GGVenturesSpider):
    name = 'lux_0001'
    start_urls = ['https://www.shu.lu/contact/']
    country = "Luxembourg"
    ...
    static_name = "SHU - Sacred Heart University Luxembourg"
    static_logo = "https://www.shu.lu/wp-content/uploads/2021/03/sacred-heart-university-luxembourg-300-v4.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.shu.lu/category/events/"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.multi_event_pages(num_of_pages=3,event_links_xpath="//h2[@class='entry-title']/a",next_page_xpath="//a[@class='next page-numbers']",get_next_month=True,click_next_month=False):
                ...
                if self.unique_event_checker(url_substring=['www.shu.lu']):
