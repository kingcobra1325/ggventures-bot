...
class Prt0006Spider(GGVenturesSpider):
    name = 'prt_0006'
    start_urls = ['https://www.novasbe.unl.pt/pt/sobre-nos/contactos']
    country = "Portugal"
    ...
    static_name = "Universidade Nova de Lisboa,Faculdade de Economia"
