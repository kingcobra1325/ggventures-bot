...
class Kwt0003Spider(GGVenturesSpider):
    name = 'kwt_0003'
    start_urls = ['https://cbaweb.ku.edu.kw/']
    country = "Kuwait"
    ...
    static_name = "Kuwait University,College of Business Administration (CBA)"
    static_logo = "https://cbaweb.ku.edu.kw/wp-content/uploads/2021/11/logo2-1-380x61.jpg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://cbaweb.ku.edu.kw/events/"

    university_contact_info_xpath = "//h4[text()='Contact']/parent::div/parent::div/parent::div/parent::div/parent::div"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//h3[contains(@class,'event-title')]/a"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=['cbaweb.ku.edu.kw/events']):
                    ...
                    item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//ul[@class='entry-event-info']").text
                    item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//ul[@class='entry-event-info']").text
