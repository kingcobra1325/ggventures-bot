...
class Chn0053Spider(GGVenturesSpider):
    name = 'chn_0053'
    start_urls = ["http://english.zzu.edu.cn/index.htm"]
    country = 'China'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Zhenghzou University"
    
    static_logo = "http://english.zzu.edu.cn/img/logo/headerlogo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "http://english.zzu.edu.cn/news_and_events/Events.htm"

    university_contact_info_xpath = "//footer//div[@class='row']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//div[@class='same']/a"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=["http://english.zzu.edu.cn/info/"]):
                    ...
                    item_data['event_name'] = self.Mth.WebDriverWait(self.getter,20).until(self.Mth.EC.presence_of_element_located((self.Mth.By.XPATH,"//h3"))).get_attribute('textContent')
                    
                    item_data['event_desc'] = self.desc_images(desc_xpath="//div[starts-with(@id,'vsb_content')]")
