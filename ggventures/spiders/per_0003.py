...
class Per0003Spider(GGVenturesSpider):
    name = 'per_0003'
    start_urls = ['https://pbs.edu.pe/contactenos/']
    country = "Peru"
    ...
    static_name = "Universidad del Pacífico,Business School"
    static_logo = "http://reclamaciones.up.edu.pe/img/logo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://pbs.edu.pe/eventos/"
