...
class Fin0003Spider(GGVenturesSpider):
    name = 'fin_0003'
    start_urls = ['https://www.helsinki.fi/en/']
    country = "Finland"
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404,429]

    static_name = "TKK - Helsinki University of Technology,Institute of Strategy and International Business"
    static_logo = "https://upload.wikimedia.org/wikipedia/en/0/0e/Helsinki_University_of_Technology_logo.png"
