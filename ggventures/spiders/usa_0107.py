...
class Usa0107Spider(GGVenturesSpider):
    name = 'usa_0107'
    start_urls = ["https://www.colorado.edu/business/leeds-directory/contact-us"]
    country = 'US'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "University of Colorado at Boulder,Colorado Leeds School of Business"
