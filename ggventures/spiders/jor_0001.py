...
class Jor0001Spider(GGVenturesSpider):
    name = 'jor_0001'
    start_urls = ['https://www.bau.edu.jo/index.aspx']
    country = "Jordan"
    ...
    static_name = "Al Balqa' Applied University (BAU),Faculty of Planning and Management"
    static_logo = "https://old.bau.edu.jo/colleges/images_en/logo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.bau.edu.jo/UpcomingEvents.aspx"

    university_contact_info_xpath = "//table[@class='baumasterfootertable']"
