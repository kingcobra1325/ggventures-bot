...
class Usa0005Spider(GGVenturesSpider):
    name = 'usa_0005'
    start_urls = ["https://zicklin.baruch.cuny.edu/contact-us/"]
    country = 'US'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Baruch College,City University of New York (CUNY),Zicklin School of Business"
    
    static_logo = "https://zicklin.baruch.cuny.edu/wp-content/themes/ZKiFactory/img/icons/baruch-logo@2x.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://zicklin.baruch.cuny.edu/events/"
