...
class Rus0013Spider(GGVenturesSpider):
    name = 'rus_0013'
    start_urls = ["https://pstu.ru/en/about/contacts/"]
    country = 'Russia'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Perm State Technical University,Regional Management Center"
    
    static_logo = "https://pstu.ru/_images/newpstu2019/logo.png"
