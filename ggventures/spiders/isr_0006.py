...
class Isr0006Spider(GGVenturesSpider):
    name = 'isr_0006'
    start_urls = ['https://bschool.hevra.haifa.ac.il/index.php/en/']
    country = "Israel"
    ...
    static_name = "University of Haifa,The Haifa Graduate School of Management"
    static_logo = "https://www.haifa.ac.il/wp-content/uploads/2019/10/WhiteUnivLogo-1024x886.png"
