...
class Aus0008Spider(GGVenturesSpider):
    name = 'aus_0008'
    start_urls = ["https://www.griffith.edu.au/griffith-business-school/contact-griffith-business-school"]
    country = 'Australia'
    # eventbrite_id = 6221361805

    handle_httpstatus_list = [301,302,403,404,410]

    static_name = "Griffith University,Griffith Business School"
    
    static_logo = "https://www.griffith.edu.au/_globaldesigns/gen-10/images/griffith-logo-2.svg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://app.secure.griffith.edu.au/events/category/Griffith%20Business%20School"

    university_contact_info_xpath = "//div[@class='gu4']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//h3/a"):
                ...
                if self.unique_event_checker(url_substring=["https://app.secure.griffith.edu.au/events/event"]):
