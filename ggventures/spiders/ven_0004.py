...
class Ven0004Spider(GGVenturesSpider):
    name = 'ven_0004'
    start_urls = ["https://www.dcea.usb.ve/"]
    country = 'Venezuela'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Universidad Simón Bolívar,Departamento de Ciencias Económicas y Administrativas"
