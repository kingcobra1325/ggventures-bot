...
class Sau0003Spider(GGVenturesSpider):
    name = 'sau_0003'
    start_urls = ['https://fea.kau.edu.sa/Default-120-EN/']
    ...
    static_name = "King Abdulaziz University (KAU),Faculty of Economics and Administration"
