...
class Isr0005Spider(GGVenturesSpider):
    name = 'isr_0005'
    start_urls = ['https://en-coller.tau.ac.il/contact-us']
    country = "Israel"
    ...
    static_name = "Tel Aviv University,Leon Recanati Graduate School of Business Administration"
    static_logo = "https://english.tau.ac.il/sites/default/files/TAU_Logo_HomePage_Eng.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://en-coller.tau.ac.il/career-events-calendar"
