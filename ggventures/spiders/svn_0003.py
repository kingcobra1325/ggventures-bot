...
class Svn0003Spider(GGVenturesSpider):
    name = 'svn_0003'
    start_urls = ['http://www.ef.uni-lj.si/contact_information']
    country = "Slovenia"
    ...
    static_name = "University of Ljubljana,Faculty of Economics"
    static_logo = "http://www.ef.uni-lj.si/media/image_layout/bg-logo-en.png"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.multi_event_pages(num_of_pages=5,event_links_xpath="//h2/a",next_page_xpath="//a[text()='»']",get_next_month=True):
