...
class Zaf0012Spider(GGVenturesSpider):
    name = 'zaf_0012'
    ...
    static_name = "UNISA - University of South Africa,Graduate School of Business Leadership (SBL)"
    
    static_logo = "https://pbs.twimg.com/profile_images/750613246000914433/792kyd8K_400x400.jpg"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.unisa.ac.za/sites/sbl/default/News-&-events/Events"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.driver.find_elements(self.Mth.By.XPATH,"//h3/ancestor::div[@class='row']"):
            # for link in self.events_list(event_links_xpath="//p/a"):
                ...
                item_data['event_name'] = self.Mth.WebDriverWait(self.driver,20).until(self.Mth.EC.presence_of_element_located((self.Mth.By.XPATH,".//h3"))).get_attribute('textContent')
                
                item_data['event_desc'] = self.desc_images(desc_xpath=".//p",use_getter=False)

                item_data['event_date'] = self.driver.find_element(self.Mth.By.XPATH,".//table").get_attribute('textContent')
                item_data['event_time'] = self.driver.find_element(self.Mth.By.XPATH,".//table").get_attribute('textContent')
