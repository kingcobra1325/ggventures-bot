...
class Rus0002Spider(GGVenturesSpider):
    name = 'rus_0002'
    start_urls = ["http://mba.vavt.ru/#contacts"]
    country = 'Russia'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "HCMS - Higher Commercial Management School,Ministry of Economic Development and Trade of the RF"
    
    static_logo = "https://static.tildacdn.com/tild6263-3436-4265-b364-666537313762/logo.svg"
