...
class Pol0008Spider(GGVenturesSpider):
    name = 'pol_0008'
    start_urls = ["https://ue.poznan.pl/en/university,c13/contact,c333/"]
    country = 'Poland'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "The Poznan University of Economics"
    
    static_logo = "https://ue.poznan.pl/themes/img/logo_en.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.econ.umk.pl/en/calendar/"

    university_contact_info_xpath = "//section[@class='m_big']"
