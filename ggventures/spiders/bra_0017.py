        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//article//span[text()='Eventos']//ancestor::a"):
                ...
                if self.unique_event_checker(url_substring=["https://www.mackenzie.br/noticias/artigo"]):
                    ...
                    item_data['event_desc'] = self.desc_images(desc_xpath="//div[@itemprop='articleBody']")

                    item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//strong[contains(text(),'Serviço')]/..").get_attribute('textContent')
                    item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//strong[contains(text(),'Serviço')]/..").get_attribute('textContent')
