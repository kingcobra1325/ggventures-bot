...
class Irn0002Spider(GGVenturesSpider):
    name = 'irn_0002'
    start_urls = ['https://www.acronymfinder.com/Qeshm-Institute-of-Higher-Education-(Tehran%2C-Iran)-(QIHE).html/']
    country = "Iran"
    ...
    static_name = "Qeshm Institute of Higher Education (QIHE)"
    static_logo = "https://www.feb.ui.ac.id/uploads/2021/01/logo-feb-1.png"
