...
class Twn0002Spider(GGVenturesSpider):
    name = 'twn_0002'
    start_urls = ["https://contactus.ncku.edu.tw/"]
    country = 'Taiwan'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "National Chiao-Tung University,College of Management"
    
    static_logo = "https://upload.wikimedia.org/wikipedia/en/2/29/Iimlogo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://activity.ncku.edu.tw/index.php?c=apply&m=index&ncku=ncku&lang=eng"
