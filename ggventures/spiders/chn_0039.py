        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//ul[@class='list01']/li/a"):
                ...
                if self.unique_event_checker(url_substring=["http://english.uibe.edu.cn/events/"]):
                    ...
                    item_data['event_name'] = self.Mth.WebDriverWait(self.getter,20).until(self.Mth.EC.presence_of_element_located((self.Mth.By.XPATH,"//div[@class='essay_title']"))).get_attribute('textContent')
                    
                    item_data['event_desc'] = self.desc_images(desc_xpath="//div[starts-with(@class,'article')]")

                    # item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//div[starts-with(@class,'article')]").get_attribute('textContent')
                    # item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//div[starts-with(@class,'article')]").get_attribute('textContent')
