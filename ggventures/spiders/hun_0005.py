...
class Hun0005Spider(GGVenturesSpider):
    name = 'hun_0005'
    start_urls = ['https://ktk.pte.hu/en/contact']
    country = "Hungary"
    ...
    static_name = "University of Pécs,Faculty of Business and Economics"
    static_logo = "https://ktk.pte.hu/sites/ktk.pte.hu/files/images/infographics/logo_en.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://ktk.pte.hu/en/events"

    university_contact_info_xpath = "//div[@class='contact-details']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//div[@class='event-date-wrapper']/a"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=['ktk.pte.hu/en/events']):
                    ...
                    item_data['event_desc'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='event-body']").get_attribute('textContent')
                    # try:
                    ...
                    item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//h3[@class='event-date']").get_attribute('textContent')
                    item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//h3[@class='event-date']").get_attribute('textContent')
