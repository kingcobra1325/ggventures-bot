...
class Jpn0016Spider(GGVenturesSpider):
    name = 'jpn_0016'
    start_urls = ["http://www.e.u-tokyo.ac.jp/fservice/address/address-e.html"]
    country = 'Japan'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "The University of Tokyo,Faculty of Economics"
    
    static_logo = "http://www.e.u-tokyo.ac.jp/asset/img/common/logo00e.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "http://www.e.u-tokyo.ac.jp/events-e.html"

    university_contact_info_xpath = "//section[@id='sec2']"
