...
class Zaf0008Spider(GGVenturesSpider):
    name = 'zaf_0008'
    start_urls = ["https://regent.ac.za/contact-us/"]
    country = 'South Africa'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Regent Business School"
    
    static_logo = "https://regent.ac.za/wp-content/uploads/2021/01/cropped-RBS-Web-logo-NEW-2.jpg.webp"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://regent.ac.za/events/"

    university_contact_info_xpath = "(//div[@class='elementor-widget-wrap'])[2]"
