...
class Usa0121Spider(GGVenturesSpider):
    name = 'usa_0121'
    start_urls = ["https://www.herbert.miami.edu/about/contact-us.html"]
    country = 'US'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "University of Miami,School of Business"
    
    static_logo = "https://mma.prnewswire.com/media/1582723/MIAMI_BUSINESS_big.jpg?p=facebook"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://events.miami.edu/calendar"

    university_contact_info_xpath = "//div[starts-with(@class,'initial-12')]"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//h3[@class='em-card_title']/a"):
                ...
                if self.unique_event_checker(url_substring=["https://events.miami.edu/event/"]):
