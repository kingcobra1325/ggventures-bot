...
class Bol0001Spider(GGVenturesSpider):
    name = 'bol_0001'
    start_urls = ['http://epc-ucb.edu.bo/epc/index.php/contacto/formulario-de-solicitud-de-informacion']
    country = "Bolivia"
    ...
    static_name = "Universidad Católica Boliviana,Maestrías para el Desarollo (MpD)"
    static_logo = "http://epc-ucb.edu.bo/epc/images/2022/ucb_56_blanco.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "http://epc-ucb.edu.bo/epc/"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//h3[text()='Events']/following-sibling::div//a"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=['newsroom.aua.am/event']):
                    ...
                    item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//div[contains(@class,'tribe-events-schedule')]/h2").get_attribute('textContent')
                    item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//div[contains(@class,'tribe-events-schedule')]/h2").get_attribute('textContent')
