...
class Swe0001Spider(GGVenturesSpider):
    name = 'swe_0001'
    start_urls = ["https://www.gu.se/en/school-business-economics-law/about-us/contact"]
    country = 'Sweden'
    ...
    parse_code_link = "https://www.gu.se/en/school-business-economics-law"
