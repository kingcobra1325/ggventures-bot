...
class Ind0024Spider(GGVenturesSpider):
    name = 'ind_0024'
    start_urls = ["https://www.imt.edu/contact-us/"]
    country = 'India'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Institute of Management Technology"
    
    static_logo = "https://upload.wikimedia.org/wikipedia/en/8/84/Institute_of_Management_Technology%2C_Ghaziabad_logo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.imt.edu/"

    university_contact_info_xpath = "//div[starts-with(@class,'et_builder_inner_content')]"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//div[contains(@class,'et_pb_column_7 ')]//a"):
