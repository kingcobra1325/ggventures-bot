...
class Kaz0002Spider(GGVenturesSpider):
    name = 'kaz_0002'
    start_urls = ['https://www.kimep.kz/bang-college-of-business/en/']
    country = "Kazakhstan"
    ...
    static_name = "KIMEP,Bang College of Business"
    static_logo = "https://www.kimep.kz/wp-content/uploads/2014/11/logo-min.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://iab.academy/all-events/"

    university_contact_info_xpath = "//div[@class='quform-spacer' and contains(text(),'call')]"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//div[@class='evo_event_schema']/a"):
                self.getter.get(link)
                if self.unique_event_checker(url_substring=['iab.academy/events']):
                    ...
                    item_data['event_date'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='elementor-widget-wrap']").text
                    item_data['event_time'] = self.getter.find_element(self.Mth.By.XPATH,"//div[@class='elementor-widget-wrap']").text
