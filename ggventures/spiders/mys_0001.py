...
class Mys0001Spider(GGVenturesSpider):
    name = 'mys_0001'
    start_urls = ['https://www.ukm.my/studyukm/contact/']
    country = "Malaysia"
    ...
    static_name = "Universiti Kebangsaan Malaysia (UKM),Faculty of Economics and Business"
    static_logo = "https://landportal.org/sites/landportal.org/files/styles/220heightmax/public/UKM-logo-608x370.jpg?itok=nJIKWIA8"
