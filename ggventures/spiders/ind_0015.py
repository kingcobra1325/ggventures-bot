...
class Ind0015Spider(GGVenturesSpider):
    name = 'ind_0015'
    start_urls = ["https://www.iimidr.ac.in/"]
    country = 'India'
    # eventbrite_id = 6221361805

    # handle_httpstatus_list = [301,302,403,404]

    static_name = "Indian Institute of Management Indore (IIM-I)"
    
    static_logo = "https://www.iimidr.ac.in/wp-content/themes/iim/images/iimi-logo.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://www.iimcal.ac.in/events"

    university_contact_info_xpath = "//h4[text()='CONTACT']/following::div"
