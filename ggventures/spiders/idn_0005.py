...
class Idn0005Spider(GGVenturesSpider):
    name = 'idn_0005'
    start_urls = ['https://pmbs.ac.id/']
    country = "Indonesia"
    ...
    static_name = "Prasetiya Mulya Business School"
    static_logo = "https://pmbs.ac.id/wp-content/uploads/2022/01/Logo-Univ-40tahun-01.png"

    # MAIN EVENTS LIST PAGE
    parse_code_link = "https://pmbs.ac.id/events/"

    university_contact_info_xpath = "//div[@id='text-38']"
    ...
    def parse_code(self,response):
        ...
        ####################
            ...
            for link in self.events_list(event_links_xpath="//td//a"):
                ...
                if self.unique_event_checker(url_substring=['pmbs.ac.id']):
